...
def _profile_literal(profile) -> str:
    """The six persisted profile values, handed back as ACL2 decoded them."""
...
class FrameSession:
    ...
    def post_boundary(self, profile, msgid: bytes, payload_length: int,
        ...
        literal = _profile_literal(profile)
        value = self.call(
