...
for support in packaging/fn packaging/fn-native packaging/fn-native.service.in packaging/net.fn.native.plist.in; do
...
install -m 0755 packaging/fn-native "$bindir/fn-native"
