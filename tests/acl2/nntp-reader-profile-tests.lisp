...
;
; The CAPABILITIES body is the second exception, for the opposite reason: RFC
; 3977 section 5.2 dictates no capability list, so the pin is evidence of what
; this server advertises and is re-quoted from an `ld` of the served step
; whenever books/nntp-responses.lisp changes the labels, never typed.  It last
; moved when HDR, LIST ACTIVE.TIMES and LIST HEADERS were implemented.
(in-package "ACL2")
...
(assert-event
 (equal (rp-reply *rp-session0* *rp-archive* *rp-env* (67 65 80 65 66 73 76 73 84 73 69 83))
        (list (fn-nntp-reply-effect
               '(49 48 49 32 99 97 112 97 98 105 108 105 116 121 32 108 105 115 116 32 102 111 108 108 111 119 115 13 10 86 69 82 83 73 79 78 32 50 13 10 82 69 65 68 69 82 13 10 79 86 69 82 32 77 83 71 73 68 13 10 72 68 82 13 10 88 80 65 84 13 10 78 69 87 78 69 87 83 13 10 76 73 83 84 32 65 67 84 73 86 69 32 65 67 84 73 86 69 46 84 73 77 69 83 32 67 79 85 78 84 83 32 72 69 65 68 69 82 83 32 77 79 84 68 32 78 69 87 83 71 82 79 85 80 83 32 79 86 69 82 86 73 69 87 46 70 77 84 13 10 73 77 80 76 69 77 69 78 84 65 84 73 79 78 32 102 110 45 110 110 116 112 45 108 97 98 13 10 46 13 10)))))
