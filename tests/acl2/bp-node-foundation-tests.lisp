...
(defconst *bpnf-s0* (fn-bpnf-state *bpnf-base* nil nil nil nil nil nil 3))
...
(defconst *bpnf-stale-epoch*
  (fn-bpnf-step *bpnf-pending* '(:persist-result 2 17 :durable)))
(defconst *bpnf-stale-op*
  (fn-bpnf-step *bpnf-pending* '(:persist-result 3 18 :durable)))
...
(assert-event (not (fn-bpnf-operation-matchp
                    (fn-bpnf-issued *bpnf-pending*) 2 17)))
(assert-event (not (fn-bpnf-operation-matchp
                    (fn-bpnf-issued *bpnf-pending*) 3 18)))
(must-fail
 (assert-event (not (fn-bpnf-operation-matchp
                     (fn-bpnf-issued *bpnf-pending*) 3 17))))

(defconst *bpnf-accepted*
  (fn-bpnf-step *bpnf-pending* '(:persist-result 3 17 :durable)))
...
(assert-event (null (fn-bpnf-answer-effects
                     (fn-bpnf-step (fn-bpnf-answer-state *bpnf-q-proposal*)
                                    '(:persist-result 2 18 :durable)))))
(defconst *bpnf-q-accepted*
  (fn-bpnf-step (fn-bpnf-answer-state *bpnf-q-proposal*)
                 '(:persist-result 3 18 :durable)))
...
(defconst *bpnf-uncertain*
  (fn-bpnf-step *bpnf-pending* '(:persist-result 3 17 :uncertain)))
