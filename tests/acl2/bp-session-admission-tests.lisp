...
(defconst *bpat-rows*
  (list (fn-cfg-row-make "peer" "path-identity" "peer.example.invalid" 0)
        ...
        (fn-cfg-row-make "peer" "bp-boundary-originators"
                         "all-co-resident" 0)))
(defconst *bpat-cfg*
  (fn-cfg-make 7 (fn-cfg-value-make nil 0 nil nil nil *bpat-rows* nil nil nil)))
(defconst *bpat-no-trust*
  (fn-cfg-make 7 (fn-cfg-value-make nil 0 nil nil nil
                                  (append (take 3 *bpat-rows*)
                                          (cddddr *bpat-rows*)) nil nil nil)))
...
(defun bpat-cfg (rows)
  (fn-cfg-make 7 (fn-cfg-value-make nil 0 nil nil nil rows nil nil nil)))
...
(must-fail (assert-event   ; not a configuration
            (bpat-unenrolledp
             (fn-cfg-make 7 (fn-cfg-value-make '(junk) 0 nil nil nil
                              (append *bpat-rows* *bpat-carries-x*) nil nil nil))
             *bpat-p* 7)))
