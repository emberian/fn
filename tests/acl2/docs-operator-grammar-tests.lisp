...
(defconst *fn-docs-operator-argv*
  '(
    ...
    ("docs/operator.md" 216 "store" "compact")
    ("docs/operator.md" 296 "obligations")
    ("docs/operator.md" 299 "pins")
    ("docs/operator.md" 392 "health")
    ("docs/operator.md" 567 "bp-boundary" "add" "relay-r1" "r1.example" "dtn://neighbour/" "1119" "carries" "dtn://far-node/")
    ("docs/operator.md" 568 "bp-boundary" "add" "far-node" "far.example" "dtn://far-node/" "1120" "fn.*" "32768" "16")
    ("docs/operator.md" 730 "peer" "add" "peer1" "news.example.invalid" "127.0.0.1" "1119" "fn.*" "fn.*" "source-address" "127.0.0.1" "true")
    ("docs/operator.md" 1065 "principal" "bind" "alice" "9261767a9261767a9261767a9261767a9261767a9261767a9261767a9261767a")
    ("docs/operator.md" 1066 "policy" "set" "posting-policy" "bound-logins")
    ("docs/operator.md" 1130 "store" "needs-upgrade")
    ("docs/operator.md" 1134 "store" "upgrade-profile" "--max-transactions" "1000")
    ("docs/operator.md" 1135 "store" "rollback-check" "/srv/kept/config.json.format-7")
    ("docs/operator.md" 1136 "store" "rollback-check" "--snapshot" "/srv/snapshot/store")))
