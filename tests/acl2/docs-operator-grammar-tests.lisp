...
(defconst *fn-docs-operator-argv*
  '(
    ...
    ("docs/install.md#4-reinstalling-and-moving-data" 1 "store" "export" "/var/lib/fn-export")
    ("docs/install.md#4-reinstalling-and-moving-data" 2 "store" "import" "/var/lib/fn-export")
