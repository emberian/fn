...
(defconst *fn-docs-operator-argv*
  '(
    ...
    ("docs/operator.md" 1192 "principal" "bind" "alice" "9261767a9261767a9261767a9261767a9261767a9261767a9261767a9261767a")
    ("docs/operator.md" 1193 "policy" "set" "posting-policy" "bound-logins")
    ("docs/operator.md" 1225 "control" "grant" "9261767a9261767a9261767a9261767a9261767a9261767a9261767a9261767a" "keys" "fn.keys")
    ("docs/operator.md" 1226 "keys" "redecide" "<a1@example.invalid>")
    ("docs/operator.md" 1255 "policy" "set" "exposure-connections" "200")
    ("docs/operator.md" 1256 "policy" "set" "exposure-per-address" "8")
    ("docs/operator.md" 1257 "policy" "set" "exposure-steps-per-second" "64")
    ("docs/operator.md" 1258 "policy" "set" "exposure-first-seconds" "60")
    ("docs/operator.md" 1259 "policy" "set" "exposure-idle-seconds" "600")
