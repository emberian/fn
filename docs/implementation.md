...
| [NNTP reader](../books/nntp.lisp) | Experimental reader commands including LISTGROUP ranges/cursors and filtered LIST ACTIVE/NEWSGROUPS over committed state, with independent response transcripts | Incomplete READER bundle; no signed injection. POST is [`books/nntp-post.lisp`](../books/nntp-post.lisp) and RFC 4643 authentication is [`books/nntp-auth.lisp`](../books/nntp-auth.lisp), both above this book; the credential and the posting allowance reach a RUNNING server as of 2026-09-21 ([auth-live](../planning/evidence/auth-live-2026-09-21.md)) |
