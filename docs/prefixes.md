...
| `fn-bpn-` | `bp-node` | fn as a BPv7 node: the configuration, `fn-bpn-send` (an ADU becomes a bundle this node authored), `fn-bpn-receive` (a peer's octets become an accepted bundle, a refusal or an uncertain outcome), and the §5.4 lifetime and hop-count forwarding decisions |
