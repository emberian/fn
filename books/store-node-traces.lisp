...
(defthm fn-snt-initial-relation
  ...
  :hints (("Goal" :in-theory (enable fn-sf-replay-node fn-replay fn-replay-loop
                         fn-node-initial-state fn-node-stage fn-node-acceptance
                         fn-state-next-txid fn-state-pending fn-state-fenced
                         fn-replay-advance-txid fn-node-statep fn-statep fn-retain-statep))))
...
(defthm fn-snt-state-reconstruction
  (implies (fn-sn-statep s)
           (equal (list (car s) (cadr s) (caddr s) (cadddr s)) s))
  :hints (("Goal" :use ((:instance fn-snt-node-reconstruct (node s)))
           :in-theory (enable fn-node-acceptance fn-node-stage))))
(defthm fn-snt-file-component-valid
  (implies (fn-sn-statep s) (fn-sf-statep (caddr s))))
(defthm fn-snt-node-component-valid
  (implies (fn-sn-statep s) (fn-node-statep (cadddr s))))
...
(defthm fn-snt-step-success-history-monotone
  ...
  :hints (("Goal" :cases ((fn-sn-completion-enabledp s))
           ...
           :in-theory (disable fn-sn-prepare fn-sn-io fn-sn-finish fn-sn-crash
             fn-sn-recover fn-sn-completion-enabledp fn-sf-successes
             fn-sn-files fn-sf-prefixp fn-snt-relation))))
