...
(defthm fn-nntp-active-times-lines-are-clean
  ...
  :hints (("Goal" :in-theory (disable fn-nntp-safe-group-namep
...
; -----------------------------------------------------------------------------
; Export.  The keystones stay enabled; the two append/printable bridges are
; proof vocabulary and are withdrawn under a name, because left enabled
; fn-nntp-printable-token-is-a-clean-field backchains on true-listp, which is
; the shape of rule books/nntp-invariants.lisp measured as the cause of its
; 1800 s runs.
(deftheory fn-nntp-legacy-vocabulary
  '(fn-nntp-printable-token-is-a-clean-field
    fn-nntp-safe-group-name-renders-a-clean-field))
(in-theory (disable fn-nntp-hdr-clean-field-listp fn-nntp-legacy-vocabulary))
