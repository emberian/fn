...
; A test constant computed through a seam is written as a `make-event' whose
; expansion is evaluated with attachments -- ACL2 evaluates a `defconst'
; body without them (:DOC ignored-attachment) -- as
; tests/acl2/stx-transit-tests.lisp does.
