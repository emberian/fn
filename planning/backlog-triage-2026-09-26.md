...
- PKT-463 keys-and-accounts-2's remainder: PKT-433 (b) to (d) and PKT-211 unchanged, fn_verify `revoked` exercised natively, and tests/acl2/login-binding-live-tests at 11.8 s at two jobs (over D26's 10 s; r3 run-20260926T120522Z-4a12) (keys-and-accounts-2)
