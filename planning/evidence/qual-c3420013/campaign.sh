#!/bin/sh
# qual-c3420013 campaign: the 10 compaction cuts and 25 cuts (one run), the
...
set -u
S=/tank/fn/scratch/qual-c3420013/campaign
GT=/tank/fn/gates/qual-c3420013-20260925
G=$GT/build/images/c3420013
...
mkdir -p $S
cd /tank/fn/scratch/qual-c3420013/ctree
...
/usr/bin/time -v python3 ../d25b_matrix.py $G/fn-host-developer /tank/fn/scratch/d25-dup/img/build/fn-host-developer $S/d25-work 11396 /tank/fn/scratch/qual-c3420013/bin/test-openssl > $S/d25-matrix.log 2>&1; echo "rc=$?" >> $S/d25-matrix.log; fi
