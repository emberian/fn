#!/usr/bin/env python3
"""qual-c3420013 manual web pass: a scratch node on the production image with
...
S = Path("/tank/fn/scratch/qual-c3420013")
T = S / "tree"
I = Path("/tank/fn/gates/qual-c3420013-20260925/build/images/c3420013")
W = S / "web"
OUT = W / "pages"
OPENSSL = str(S / "bin" / "test-openssl")
USER, SECRET = "reader", "web-pass-c3420013"
