...
if grep -n -E "ACL2 Error|HARD ACL2 ERROR|Raw Lisp Break|debugger invoked|Unhandled" build/freeze/native-build-developer.log; then echo "== build log has errors"; exit 1; fi
