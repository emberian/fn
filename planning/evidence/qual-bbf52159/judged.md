...
| `marker-created` | `fn-bs-marker-program` | present | served | ready True / 3 / -9 | 2, .stage- | 2 2 0 | present | accepted operator post DUPLICATE rc 0 | PASS |
| `marker-created` | `fn-bs-marker-program` | present | store/recover | -9 | 2, .stage- | 2 2 0 | present | duplicate rc 0 | PASS |
| `marker-written` | `fn-bs-marker-program` | present | served | ready True / 3 / -9 | 2, .stage- | 2 2 0 | present | accepted operator post DUPLICATE rc 0 | PASS |
| `marker-written` | `fn-bs-marker-program` | present | store/recover | -9 | 2, .stage- | 2 2 0 | present | duplicate rc 0 | PASS |
| `marker-staged-durable` | `fn-bs-marker-program` | present | served | ready True / 3 / -9 | 2, .stage- | 2 2 0 | present | accepted operator post DUPLICATE rc 0 | PASS |
| `marker-staged-durable` | `fn-bs-marker-program` | present | store/recover | -9 | 2, .stage- | 2 2 0 | present | duplicate rc 0 | PASS |
| `marker-replaced` | `fn-bs-marker-program` | present | served | ready True / 3 / -9 | 2, none | 2 2 0 | present | accepted operator post DUPLICATE rc 0 | PASS |
| `marker-replaced` | `fn-bs-marker-program` | present | store/recover | -9 | 2, none | 2 2 0 | present | duplicate rc 0 | PASS |
| `marker-durable` | `fn-bs-marker-program` | present | served | ready True / 3 / -9 | 2, none | 2 2 0 | present | accepted operator post DUPLICATE rc 0 | PASS |
| `marker-durable` | `fn-bs-marker-program` | present | store/recover | -9 | 2, none | 2 2 0 | present | duplicate rc 0 | PASS |
...
cut observations: 60 passed: 60 (failing observations are counted per cut and column)
failures:
...
| record-linked | eio | either | `441 posting failed; the outcome is uncertain, do not repost` | 3 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| record-attempted | kill | present | `(closed, no reply)` | -9 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
...
| record-durable | kill | present | `(closed, no reply)` | -9 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
...
| record-completing | eio | present | `441 posting failed; the outcome is uncertain, do not repost` | 3 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
...
| record-stage-unlinked | eio | present | `240 article received OK` | 0 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| record-staging-cleaned | kill | present | `(closed, no reply)` | -9 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
...
| marker-created | kill | present | `(closed, no reply)` | -9 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| marker-created | eio | present | `441 posting failed; the outcome is uncertain, do not repost` | 3 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| marker-written | kill | present | `(closed, no reply)` | -9 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| marker-written | eio | present | `441 posting failed; the outcome is uncertain, do not repost` | 3 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| marker-staged-durable | kill | present | `(closed, no reply)` | -9 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| marker-staged-durable | eio | present | `441 posting failed; the outcome is uncertain, do not repost` | 3 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| marker-replaced | kill | present | `(closed, no reply)` | -9 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| marker-replaced | eio | present | `441 posting failed; the outcome is uncertain, do not repost` | 3 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| marker-durable | kill | present | `(closed, no reply)` | -9 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| marker-durable | eio | present | `441 posting failed; the outcome is uncertain, do not repost` | 3 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| finish-consumed | kill | present | `(closed, no reply)` | -9 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
...
| finish-durable | eio | present | `441 posting failed; the outcome is uncertain, do not repost` | 3 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
...
| prod-accepted-then-sigkill | fn-host | - | `240 article received OK` | -9 | present | True/True | True/True/True | `441 posting failed; this article is already stored here` |
| prod-sigkill-mid-article | fn-host | - | `ConnectionResetError` | -9 | absent | True/True | n/a (1 / 430) | `-` |
