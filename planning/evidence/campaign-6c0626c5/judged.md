...
| finish-consumed | eio | present | `441 posting failed; the outcome is uncertain, do not repost` | 3 | present | True/True | True/True/True | `441 posting failed; a different article with this Message-ID is stored here` |
