...
220 rows: 142 accepted, 44 refused, 2 uncertain, 31 not exercised, 1 not built; 0 row(s) did not do what they were designed to do, and 0 exited with a host fault or usage error, which is not an outcome and is counted among the not exercised. Every count here is `tools/v0_matrix.py`'s over the rows below, and `planning/evidence/v0-runs/20260925T201026.327335Z-d78ee77-397dd54da3d1/matrix.json` carries the same rows with their digest.
...
| `V0-POST-FRESH-A` | a fresh connection reads it back by Message-ID | **accepted** | accepted | yes | fn only | 220 0 <native-matrix-a5f18a6b7535-a@example.invalid> article follows |
| `V0-POST-FRESH-B` | a fresh connection reads it back by Message-ID | **accepted** | accepted | yes | fn only | 220 0 <native-matrix-a1aba1bbeaf4-b@example.invalid> article follows |
...
| `V0-POST-CLOCK-A` | a duplicate POST is refused as an article and does not cost the node its clock | **accepted** | accepted | yes | fn only | the duplicate answered '441 posting failed; this article is already stored here' and DATE afterwards answered '111 20260925201125' |
| `V0-POST-CLOCK-B` | a duplicate POST is refused as an article and does not cost the node its clock | **accepted** | accepted | yes | fn only | the duplicate answered '441 posting failed; this article is already stored here' and DATE afterwards answered '111 20260925201134' |
...
| `V0-READ-ARTICLE-A` | ARTICLE by number | **accepted** | accepted | yes | fn only | 220 1 <native-matrix-a5f18a6b7535-a@example.invalid> article follows |
| `V0-READ-ARTICLE-B` | ARTICLE by number | **accepted** | accepted | yes | fn only | 220 1 <native-matrix-a1aba1bbeaf4-b@example.invalid> article follows |
| `V0-READ-HEAD-A` | HEAD by number | **accepted** | accepted | yes | fn only | 221 1 <native-matrix-a5f18a6b7535-a@example.invalid> headers follow |
| `V0-READ-HEAD-B` | HEAD by number | **accepted** | accepted | yes | fn only | 221 1 <native-matrix-a1aba1bbeaf4-b@example.invalid> headers follow |
| `V0-READ-BODY-A` | BODY by number | **accepted** | accepted | yes | fn only | 222 1 <native-matrix-a5f18a6b7535-a@example.invalid> body follows |
| `V0-READ-BODY-B` | BODY by number | **accepted** | accepted | yes | fn only | 222 1 <native-matrix-a1aba1bbeaf4-b@example.invalid> body follows |
| `V0-READ-STAT-A` | STAT by number | **accepted** | accepted | yes | fn only | 223 1 <native-matrix-a5f18a6b7535-a@example.invalid> retrieved |
| `V0-READ-STAT-B` | STAT by number | **accepted** | accepted | yes | fn only | 223 1 <native-matrix-a1aba1bbeaf4-b@example.invalid> retrieved |
| `V0-READ-ARTICLE-MSGID-A` | ARTICLE by Message-ID | **accepted** | accepted | yes | fn only | 220 1 <native-matrix-a5f18a6b7535-a@example.invalid> article follows |
| `V0-READ-ARTICLE-MSGID-B` | ARTICLE by Message-ID | **accepted** | accepted | yes | fn only | 220 1 <native-matrix-a1aba1bbeaf4-b@example.invalid> article follows |
...
| `V0-READ-NEWNEWS-STAMP-A` | NEWNEWS since 1970 includes this node's accepted article even when its payload date differs from its acceptance | **accepted** | accepted | yes | fn only | whole-history NEWNEWS contains target <native-matrix-a5f18a6b7535-a@example.invalid>: True |
| `V0-READ-NEWNEWS-STAMP-B` | NEWNEWS since 1970 includes this node's accepted article even when its payload date differs from its acceptance | **accepted** | accepted | yes | fn only | whole-history NEWNEWS contains target <native-matrix-a1aba1bbeaf4-b@example.invalid>: True |
...
| `V0-READ-DATE-A` | DATE | **accepted** | accepted | yes | fn only | 111 20260925201126 |
| `V0-READ-DATE-B` | DATE | **accepted** | accepted | yes | fn only | 111 20260925201135 |
...
| `V0-READ-FRAMING-A` | a command split across two TCP segments is answered once, the same way | **accepted** | accepted | yes | fn only | DATE split across two segments answered '111 20260925201126' against '111 20260925201126' |
| `V0-READ-FRAMING-B` | a command split across two TCP segments is answered once, the same way | **accepted** | accepted | yes | fn only | DATE split across two segments answered '111 20260925201135' against '111 20260925201135' |
...
| `V0-INN-FEED-IN` | INN's innfeed delivers an article to fn (CHECK 238, TAKETHIS 239) and fn serves it changed at most in Path and Xref | **accepted** | accepted | yes | yes | innfeed-feeds-fn=held (CHECK+TAKETHIS: 238 <inn-lab-fed-d78ee77-20260925T201343Z@example.invalid> / 239 <inn-lab-fed-d78ee77-20260925T201343Z@example.invalid>); fn-serves-inn-article=held (changed: pa |
...
- `V0-POST-OPEN-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --user '' --secret ''`
- `V0-POST-OPEN-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --user '' --secret ''`
- `V0-POST-COMMIT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --user '' --secret ''`
- `V0-POST-COMMIT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --user '' --secret ''`
- `V0-POST-READBACK-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --user '' --secret ''`
- `V0-POST-READBACK-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --user '' --secret ''`
- `V0-POST-FRESH-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --user '' --secret ''`
- `V0-POST-FRESH-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --user '' --secret ''`
- `V0-POST-DUPLICATE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --user '' --secret ''`
- `V0-POST-DUPLICATE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --user '' --secret ''`
- `V0-POST-CLOCK-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --user '' --secret ''`
- `V0-POST-CLOCK-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --user '' --secret ''`
- `V0-POST-FROM-MAILBOX-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --user '' --secret ''`
- `V0-POST-FROM-MAILBOX-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --user '' --secret ''`
...
- `V0-READ-CAPABILITIES-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-CAPABILITIES-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-MODE-READER-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-MODE-READER-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-ACTIVE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-ACTIVE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-NEWSGROUPS-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-NEWSGROUPS-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-NEWSGROUPS-WILDMAT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-NEWSGROUPS-WILDMAT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-OVERVIEW-FMT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-OVERVIEW-FMT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-ACTIVE-TIMES-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-ACTIVE-TIMES-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-HEADERS-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-HEADERS-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-GROUP-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-GROUP-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LISTGROUP-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LISTGROUP-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HEAD-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HEAD-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-BODY-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-BODY-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-STAT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-STAT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-MSGID-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-MSGID-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-ABSENT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-ABSENT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-OVER-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-OVER-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-OVER-RANGE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-OVER-RANGE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HDR-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HDR-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XOVER-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XOVER-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XHDR-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XHDR-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XPAT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XPAT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEXT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEXT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LAST-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LAST-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-STAMP-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-STAMP-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-FUTURE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-FUTURE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-SYNTAX-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-SYNTAX-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-DATE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-DATE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HELP-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HELP-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-UNKNOWN-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-UNKNOWN-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-FRAMING-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-FRAMING-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
...
- `V0-CLIENT-NNTPLIB-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3.12 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>' --user '' --secret ''`
- `V0-CLIENT-NNTPLIB-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3.12 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>' --user '' --secret ''`
...
| 17 | node A profile scratch store | 0 | `initialized /home/hbox/fn-deploy/native-e747dbcc-d78ee77/a/profile/store` | 0.3 |
...
| 23 | node A profile service log | 0 | `accepted post path=control message-id=<profile-a@example.invalid> time=2026-09-25T20:10:44Z` | 0.2 |
| 24 | node A init scratch configuration | 0 | `MATRIX-CONFIG-STORE /home/hbox/fn-deploy/native-e747dbcc-d78ee77/a/init/store` | 0.3 |
| 25 | node A operator init | 0 | `initialized /home/hbox/fn-deploy/native-e747dbcc-d78ee77/a/init/store` | 0.3 |
...
| 34 | node B operator init | 0 | `initialized /home/hbox/fn-deploy/native-e747dbcc-d78ee77/b/init/store` | 0.4 |
...
| 57 | node A auth-required scratch store | 0 | `initialized /home/hbox/fn-deploy/native-e747dbcc-d78ee77/a/authgate/store` | 0.3 |
...
| 82 | node B path-identity | 0 | `configured generation=5 record=00000005.cfg verification=VERIFIED` | 0.9 |
| 83 | node B configured port | 0 | `11191` | 0.7 |
...
| 89 | start server (node A (native-operator), a-main) | 0 | `LISTENING 11190` | 1.5 |
| 90 | node A pid | 0 | `3732848` | 0.4 |
| 91 | start server (node B (native-operator), b-main) | 0 | `LISTENING 11191` | 1.3 |
| 92 | node B pid | 0 | `3733023` | 0.4 |
...
| 96 | node A POST cycle | 0 | `{"GROUP BEFORE": "211 0 1 0 fn.letters", "POST": "340 send article to be posted", "COMMIT": "240 article received OK", "GROUP AFTER": "211 1 1 1 fn.letters", "FRESH ARTICLE": "220 0 <native-matrix-a5f` | 0.8 |
...
| 104 | install alpha.article | 0 | `` | 0.6 |
| 105 | node A outcome duplicate | 0 | `accepted operator post DUPLICATE` | 0.8 |
| 106 | install alpha-conflict.article | 0 | `` | 0.4 |
| 107 | node A outcome refused | 1 | `refused operator post REFUSED` | 0.9 |
| 108 | install stream-a.article | 0 | `` | 0.8 |
...
| 113 | node B POST cycle | 0 | `{"GROUP BEFORE": "211 0 1 0 fn.letters", "POST": "340 send article to be posted", "COMMIT": "240 article received OK", "GROUP AFTER": "211 1 1 1 fn.letters", "FRESH ARTICLE": "220 0 <native-matrix-a1a` | 0.4 |
...
| 117 | node B AUTHINFO session | 0 | `{"CAPABILITIES BEFORE": "101 capability list follows", "advertised_before": ["VERSION", "READER", "POST", "OVER", "HDR", "XPAT", "NEWNEWS", "LIST", "IMPLEMENTATION", "IHAVE", "STREAMING", "AUTHINFO"],` | 0.7 |
...
| 132 | independent nntplib client on node B | 0 | `/home/hbox/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py:6: DeprecationWarning: 'nntplib' is deprecated and slated for removal in Python 3.13` | 0.2 |
| 133 | tin home | 0 | `` | 0.3 |
| 134 | install .newsrc | 0 | `` | 0.2 |
| 135 | install editor.sh | 0 | `` | 0.3 |
| 136 | tin client | 0 | `1790367103.489 1 --- connection` | 73.4 |
...
| 141 | transit BA: offer <beta@b.example.invalid> from B to A | 1 | `{"msgid": "<beta@b.example.invalid>", "source": "220 0 <beta@b.example.invalid> article follows", "source_lines": 9, "capabilities": ["VERSION 2", "READER", "POST", "OVER MSGID", "HDR", "XPAT", "NEWNE` | 0.8 |
...
| 149 | a second reader across node A's POST | 0 | `{"WATCHER BEFORE": "211 7 1 7 fn.letters", "POST": "340 send article to be posted", "WATCHER MID": "211 7 1 7 fn.letters", "WATCHER ARTICLE MID": "223 1 <native-matrix-a5f18a6b7535-a@example.invalid> ` | 0.6 |
...
| 155 | node A configured store | 0 | `/tank/fn/scratch/qual-e747dbcc/matrix/stores/a/store` | 0.3 |
...
| 158 | native public peering/restart witness | 0 | `NATIVE-PEERING-EXPECTED-RUNTIME b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5` | 6.3 |
| 159 | native protected peering witness | 0 | `NATIVE-PROTECTED-EXPECTED-RUNTIME b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5` | 28.4 |
| 160 | stop server node A (main) | 0 | `stopped` | 1.2 |
| 161 | node A store after the stop | 0 | `transactions=8 articles=8 staging-orphans=0 unsigned-legacy-experiment` | 0.4 |
...
| 163 | node A log tail | 0 | `refused transit connection=40 message-id=<pin.take@matrix.example.invalid> code=439 decision=refuse reason=proto-article detail=none time=2026-09-25T20:12:59Z` | 0.2 |
...
| 167 | node B log tail | 0 | `accepted peer connection=30 peer=a time=2026-09-25T20:13:00Z` | 0.2 |
| 168 | peer remove a peer that is not there | 1 | `refused operator peer administrative configuration refused: NO-SUCH-PEER` | 0.4 |
| 169 | peer remove the configured peer | 0 | `configured generation=8 record=00000008.cfg verification=VERIFIED` | 0.5 |
| 170 | inn lab | 0 | `evidence: /Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T201026.327335Z-d78ee77-397dd54da3d1/inn-lab.md` | 50.0 |
...
27. **install init.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/init/init.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG9uZSBkdXJhYmxlIG91dGNvbWUN ; Ck5ld3Nncm91cHM6IGZuLmxldHRlcnMNCkRhdGU6IEZyaSwgMjUgU2VwIDIwMjYgMjA6MTA6NDgg ; KzAwMDANCk1lc3NhZ2UtSUQ6IDxpbml0LWFAZXhhbXBsZS5pbnZhbGlkPg0KDQpTdWJtaXR0ZWQg ; b24gdGhlIEEgaW5pdCBzY3JhdGNoIG5vZGUgYnkgdGhlIHYwIG1hdHJpeC4NCg== ; FN_...`
...
93. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
...
95. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
96. **node A POST cycle** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --user '' --secret ''`
97. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
98. **node A reader surface** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>'`
99. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
...
101. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
102. **install alpha.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/alpha.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; QQ0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDoxMToy ; OCArMDAwMA0KTWVzc2FnZS1JRDogPGFscGhhQGEuZXhhbXBsZS5pbnZhbGlkPg0KDQpXcml0dGVu ; IG9uIG5vZGUgQSBieSB0aGUgdjAgbWF0cml4IHRocm91Z2ggdGhlIG5hdGl2ZSBvcGVyYXRvci...`
...
104. **install alpha.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/alpha.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; QQ0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDoxMToy ; OCArMDAwMA0KTWVzc2FnZS1JRDogPGFscGhhQGEuZXhhbXBsZS5pbnZhbGlkPg0KDQpXcml0dGVu ; IG9uIG5vZGUgQSBieSB0aGUgdjAgbWF0cml4IHRocm91Z2ggdGhlIG5hdGl2ZSBvcGVyYXRvci...`
...
106. **install alpha-conflict.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/alpha-conflict.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; QQ0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDoxMToy ; OCArMDAwMA0KTWVzc2FnZS1JRDogPGFscGhhQGEuZXhhbXBsZS5pbnZhbGlkPg0KDQpXcml0dGVu ; IG9uIG5vZGUgQSBieSB0aGUgdjAgbWF0cml4IHRocm91Z2ggdGhlIG5hdGl2ZSBvc...`
...
108. **install stream-a.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/stream-a.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IGZvciB0aGUgc3RyZWFtaW5nIG9m ; ZmVyDQpOZXdzZ3JvdXBzOiBmbi5sZXR0ZXJzDQpEYXRlOiBGcmksIDI1IFNlcCAyMDI2IDIwOjEx ; OjMyICswMDAwDQpNZXNzYWdlLUlEOiA8c3RyZWFtLWFAZXhhbXBsZS5pbnZhbGlkPg0KDQpTZWVk ; ZWQgb24gbm9kZSBBIGJ5IHRoZSB2MCBtYXRyaXguDQo= ; FN_GATE_EOF ; chmod 644 ...`
...
110. **node B server is alive** -- `kill -0 3733023 2>/dev/null && echo ALIVE || echo DEAD`
...
112. **node B server is alive** -- `kill -0 3733023 2>/dev/null && echo ALIVE || echo DEAD`
113. **node B POST cycle** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --user '' --secret ''`
114. **node B server is alive** -- `kill -0 3733023 2>/dev/null && echo ALIVE || echo DEAD`
115. **node B reader surface** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>'`
116. **node B server is alive** -- `kill -0 3733023 2>/dev/null && echo ALIVE || echo DEAD`
...
118. **node B server is alive** -- `kill -0 3733023 2>/dev/null && echo ALIVE || echo DEAD`
119. **install beta.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/b/beta.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; Qg0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDoxMToz ; NyArMDAwMA0KTWVzc2FnZS1JRDogPGJldGFAYi5leGFtcGxlLmludmFsaWQ+DQoNCldyaXR0ZW4g ; b24gbm9kZSBCIGJ5IHRoZSB2MCBtYXRyaXggdGhyb3VnaCB0aGUgbmF0aXZlIG9wZXJhdG9yLg0...`
...
121. **install beta.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/b/beta.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; Qg0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDoxMToz ; NyArMDAwMA0KTWVzc2FnZS1JRDogPGJldGFAYi5leGFtcGxlLmludmFsaWQ+DQoNCldyaXR0ZW4g ; b24gbm9kZSBCIGJ5IHRoZSB2MCBtYXRyaXggdGhyb3VnaCB0aGUgbmF0aXZlIG9wZXJhdG9yLg0...`
...
123. **install beta-conflict.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/b/beta-conflict.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; Qg0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDoxMToz ; NyArMDAwMA0KTWVzc2FnZS1JRDogPGJldGFAYi5leGFtcGxlLmludmFsaWQ+DQoNCldyaXR0ZW4g ; b24gbm9kZSBCIGJ5IHRoZSB2MCBtYXRyaXggdGhyb3VnaCB0aGUgbmF0aXZlIG9wZX...`
...
125. **install stream-b.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/b/stream-b.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IGZvciB0aGUgc3RyZWFtaW5nIG9m ; ZmVyDQpOZXdzZ3JvdXBzOiBmbi5sZXR0ZXJzDQpEYXRlOiBGcmksIDI1IFNlcCAyMDI2IDIwOjEx ; OjM5ICswMDAwDQpNZXNzYWdlLUlEOiA8c3RyZWFtLWJAZXhhbXBsZS5pbnZhbGlkPg0KDQpTZWVk ; ZWQgb24gbm9kZSBCIGJ5IHRoZSB2MCBtYXRyaXguDQo= ; FN_GATE_EOF ; chmod 644 ...`
...
127. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
128. **node B server is alive** -- `kill -0 3733023 2>/dev/null && echo ALIVE || echo DEAD`
...
131. **independent nntplib client on node A** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3.12 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py --port 11190 --group fn.letters --msgid '<native-matrix-a5f18a6b7535-a@example.invalid>' --absent '<absent@example.invalid>' --user '' --secret ''`
132. **independent nntplib client on node B** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3.12 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py --port 11191 --group fn.letters --msgid '<native-matrix-a1aba1bbeaf4-b@example.invalid>' --absent '<absent@example.invalid>' --user '' --secret ''`
...
137. **node B server is alive** -- `kill -0 3733023 2>/dev/null && echo ALIVE || echo DEAD`
...
140. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
...
143. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
...
145. **node B server is alive** -- `kill -0 3733023 2>/dev/null && echo ALIVE || echo DEAD`
...
147. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
148. **node B server is alive** -- `kill -0 3733023 2>/dev/null && echo ALIVE || echo DEAD`
...
150. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
151. **node B server is alive** -- `kill -0 3733023 2>/dev/null && echo ALIVE || echo DEAD`
...
154. **node A server is alive** -- `kill -0 3732848 2>/dev/null && echo ALIVE || echo DEAD`
...
accepted post path=control message-id=<profile-a@example.invalid> time=2026-09-25T20:10:44Z
...
{"GROUP BEFORE": "211 0 1 0 fn.letters", "POST": "340 send article to be posted", "COMMIT": "240 article received OK", "GROUP AFTER": "211 1 1 1 fn.letters", "FRESH ARTICLE": "220 0 <native-matrix-a1aba1bbeaf4-b@example.invalid> article follows", "DUPLICATE POST": "340 send article to be posted", "DUPLICATE": "441 posting failed; this article is already stored here", "DATE AFTER DUPLICATE": "111 20260925201134", "FROM POST": "340 send article to be posted", "FROM": "441 posting failed; From is not a valid mailbox list", "FROM ARTICLE": "430 no article with that message-id", "counted": true, "ok": true}
--- 114 node B server is alive (rc=0)
ALIVE
--- 115 node B reader surface (rc=0)
{"greeting": "200 fn-nntp experimental server ready", "CAPABILITIES": "101 capability list follows", "capability_lines": ["VERSION 2", "READER", "POST", "OVER MSGID", "HDR", "XPAT", "NEWNEWS", "LIST ACTIVE ACTIVE.TIMES COUNTS HEADERS NEWSGROUPS OVERVIEW.FMT", "IMPLEMENTATION fn-nntp-lab", "IHAVE", "STREAMING", "AUTHINFO USER"], "MODE READER": "200 posting allowed", "LIST ACTIVE": "215 list of active newsgroups follows", "LIST NEWSGROUPS": "215 list of newsgroups follows", "LIST OVERVIEW.FMT": "215 order of fields in overview database", "LIST ACTIVE.TIMES": "215 information follows", "LIST HEADERS": "215 field list follows", "LIST NEWSGROUPS WILDMAT": "215 list of newsgroups follows", "GROUP": "211 1 1 1 fn.letters", "group_count": 1, "group_first": 1, "group_last": 1, "LISTGROUP": "211 1 1 1 fn.letters list follows", "ARTICLE": "220 1 <native-matrix-a1aba1bbeaf4-b@example.invalid> article follows", "HEAD": "221 1 <native-matrix-a1aba1bbeaf4-b@example.invalid> headers follow", "BODY": "222 1 <native-matrix-a1aba1bbeaf4-b@example.invalid> body follows", "STAT": "223 1 <native-matrix-a1aba1bbeaf4-b@example.invalid> retrieved", "ARTICLE MSGID": "220 1 <native-matrix-a1aba1bbeaf4-b@example.invalid> article follows", "ARTICLE ABSENT": "430 no article with that message-id", "OVER": "224 overview information follows", "OVER RANGE": "224 overview information follows", "HDR": "225 headers follow", "XOVER": "224 overview information follows", "XHDR": "221 header follows", "XPAT": "221 header follows", "NEWNEWS": "230 list of new articles by message-id follows", "NEWNEWS STAMP TARGET": true, "NEWNEWS FUTURE": "230 list of new articles by message-id follows", "NEWNEWS SYNTAX": "501 syntax error", "NEXT": "421 no next article", "LAST": "422 no previous article", "DATE": "111 20260925201135", "HELP": "100 help text follows", "UNKNOWN": "500 command not recognized", "FRAMING": "111 20260925201135", "FRAMING SAME": true, "ok": true}
...
{"WATCHER BEFORE": "211 7 1 7 fn.letters", "POST": "340 send article to be posted", "WATCHER MID": "211 7 1 7 fn.letters", "WATCHER ARTICLE MID": "223 1 <native-matrix-a5f18a6b7535-a@example.invalid> retrieved", "COMMIT": "240 article received OK", "WATCHER AFTER": "211 7 1 7 fn.letters", "ok": true}
...
refused transit connection=40 message-id=<pin.take@matrix.example.invalid> code=439 decision=refuse reason=proto-article detail=none time=2026-09-25T20:12:59Z
accepted peer connection=41 peer=b time=2026-09-25T20:13:01Z
accepted peer connection=42 peer=b time=2026-09-25T20:13:01Z
...
accepted post path=served connection=42 message-id=<concurrent@example.invalid> agent=a.gate.example.invalid time=2026-09-25T20:13:01Z
accepted peer connection=44 peer=b time=2026-09-25T20:13:02Z
...
accepted peer connection=30 peer=a time=2026-09-25T20:13:00Z
accepted peer connection=31 peer=a time=2026-09-25T20:13:00Z
accepted peer connection=32 peer=a time=2026-09-25T20:13:00Z
accepted peer connection=33 peer=a time=2026-09-25T20:13:00Z
accepted peer connection=34 peer=a time=2026-09-25T20:13:00Z
accepted peer connection=35 peer=a time=2026-09-25T20:13:00Z
accepted peer connection=36 peer=a time=2026-09-25T20:13:00Z
accepted peer connection=37 peer=a time=2026-09-25T20:13:00Z
accepted peer connection=38 peer=a time=2026-09-25T20:13:00Z
accepted peer connection=39 peer=a time=2026-09-25T20:13:00Z
refused transit connection=39 message-id=<pin.take@matrix.example.invalid> code=439 decision=refuse reason=proto-article detail=none time=2026-09-25T20:13:00Z
accepted operator run
...
accepted operator peer
--- 170 inn lab (rc=0)
evidence: /Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T201026.327335Z-d78ee77-397dd54da3d1/inn-lab.md
