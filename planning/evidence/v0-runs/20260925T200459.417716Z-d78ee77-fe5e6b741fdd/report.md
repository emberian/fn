...
| rows | 220 rows: 136 accepted, 40 refused, 2 uncertain, 41 not exercised, 1 not built, 0 disagreed, 0 faulted |
...
**Execution subject.** Backend `native-operator`; deployed source `d78ee77`; runtime image `launcher sha256=ae1e2f486c93ac89bb04d189f6c5f9215903f963cb8d07f693e5a41489435142; image sha256=432622d29a28d59455e01f3e5b426036c5862db21d5f7d1205a9304ab11e3505; declared runtime=b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5; sidecar core sha256=0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08 (static only before a live-owner witness); source correspondence unestablished; live owners observed via /proc runtime sha256=b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5 and core sha256=0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08`. These are separate labels: naming the source and hashing an externally supplied image does not prove they correspond.

220 rows: 136 accepted, 40 refused, 2 uncertain, 41 not exercised, 1 not built; 0 row(s) did not do what they were designed to do, and 0 exited with a host fault or usage error, which is not an outcome and is counted among the not exercised. Every count here is `tools/v0_matrix.py`'s over the rows below, and `planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/matrix.json` carries the same rows with their digest.


**Who saw it.** 2 of the 178 outcome rows were observed by something that is not fn's own code; 176 were observed by fn talking to fn. A feature that only fn's own client has ever seen is a weaker claim than "usable between two peered servers" reads, and every row carries the client that saw it in its `client` field. Clients in this run: fn CLI (exit code) (41); stdlib nntplib on python3.12 (2); the matrix's raw-socket driver (136).
...
| `V0-AUTH-PASSWORD-B` | fn principal set-password records an AUTHINFO credential | **accepted** | accepted | yes | fn only | rc=0 matrix principal=a51e6e0486cb040737b29d0d8d52465c8c850156ca110b9b23973c03a8cc1ac3 posting=true |
...
| `V0-POST-FRESH-A` | a fresh connection reads it back by Message-ID | **accepted** | accepted | yes | fn only | 220 0 <native-matrix-94ca7a66d8e8-a@example.invalid> article follows |
| `V0-POST-FRESH-B` | a fresh connection reads it back by Message-ID | **accepted** | accepted | yes | fn only | 220 0 <native-matrix-21f50b37b6d3-b@example.invalid> article follows |
...
| `V0-POST-CLOCK-A` | a duplicate POST is refused as an article and does not cost the node its clock | **accepted** | accepted | yes | fn only | the duplicate answered '441 posting failed; this article is already stored here' and DATE afterwards answered '111 20260925200556' |
| `V0-POST-CLOCK-B` | a duplicate POST is refused as an article and does not cost the node its clock | **accepted** | accepted | yes | fn only | the duplicate answered '441 posting failed; this article is already stored here' and DATE afterwards answered '111 20260925200604' |
...
| `V0-READ-ARTICLE-A` | ARTICLE by number | **accepted** | accepted | yes | fn only | 220 1 <native-matrix-94ca7a66d8e8-a@example.invalid> article follows |
| `V0-READ-ARTICLE-B` | ARTICLE by number | **accepted** | accepted | yes | fn only | 220 1 <native-matrix-21f50b37b6d3-b@example.invalid> article follows |
| `V0-READ-HEAD-A` | HEAD by number | **accepted** | accepted | yes | fn only | 221 1 <native-matrix-94ca7a66d8e8-a@example.invalid> headers follow |
| `V0-READ-HEAD-B` | HEAD by number | **accepted** | accepted | yes | fn only | 221 1 <native-matrix-21f50b37b6d3-b@example.invalid> headers follow |
| `V0-READ-BODY-A` | BODY by number | **accepted** | accepted | yes | fn only | 222 1 <native-matrix-94ca7a66d8e8-a@example.invalid> body follows |
| `V0-READ-BODY-B` | BODY by number | **accepted** | accepted | yes | fn only | 222 1 <native-matrix-21f50b37b6d3-b@example.invalid> body follows |
| `V0-READ-STAT-A` | STAT by number | **accepted** | accepted | yes | fn only | 223 1 <native-matrix-94ca7a66d8e8-a@example.invalid> retrieved |
| `V0-READ-STAT-B` | STAT by number | **accepted** | accepted | yes | fn only | 223 1 <native-matrix-21f50b37b6d3-b@example.invalid> retrieved |
| `V0-READ-ARTICLE-MSGID-A` | ARTICLE by Message-ID | **accepted** | accepted | yes | fn only | 220 1 <native-matrix-94ca7a66d8e8-a@example.invalid> article follows |
| `V0-READ-ARTICLE-MSGID-B` | ARTICLE by Message-ID | **accepted** | accepted | yes | fn only | 220 1 <native-matrix-21f50b37b6d3-b@example.invalid> article follows |
...
| `V0-READ-NEWNEWS-STAMP-A` | NEWNEWS since 1970 includes this node's accepted article even when its payload date differs from its acceptance | **accepted** | accepted | yes | fn only | whole-history NEWNEWS contains target <native-matrix-94ca7a66d8e8-a@example.invalid>: True |
| `V0-READ-NEWNEWS-STAMP-B` | NEWNEWS since 1970 includes this node's accepted article even when its payload date differs from its acceptance | **accepted** | accepted | yes | fn only | whole-history NEWNEWS contains target <native-matrix-21f50b37b6d3-b@example.invalid>: True |
...
| `V0-READ-DATE-A` | DATE | **accepted** | accepted | yes | fn only | 111 20260925200557 |
| `V0-READ-DATE-B` | DATE | **accepted** | accepted | yes | fn only | 111 20260925200605 |
...
| `V0-READ-FRAMING-A` | a command split across two TCP segments is answered once, the same way | **accepted** | accepted | yes | fn only | DATE split across two segments answered '111 20260925200557' against '111 20260925200557' |
| `V0-READ-FRAMING-B` | a command split across two TCP segments is answered once, the same way | **accepted** | accepted | yes | fn only | DATE split across two segments answered '111 20260925200605' against '111 20260925200605' |
...
| `V0-TRANSIT-TLS-WRONG-ANCHOR` | a feed whose record names an anchor that did not issue the peer's certificate delivers nothing, and both owners stay up | **refused** | refused | yes | fn only | {"case": "wrong-anchor", "delivered": false, "identity": {"a": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96 |
| `V0-TRANSIT-AUTHINFO-WRONG` | a feed whose profile carries a wrong password delivers nothing, and both owners stay up | **refused** | refused | yes | fn only | {"case": "wrong-password", "delivered": false, "identity": {"a": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c |
| `V0-FEED-QUEUE` | an article accepted on the source enters the matching peer's outbound queue | **accepted** | accepted | yes | fn only | {"duplicate": "435", "identity": {"restart-a": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6 |
...
| `V0-FEED-JOURNAL` | the feed journal records the transfer and survives a restart | **accepted** | accepted | yes | fn only | {"duplicate": "435", "identity": {"restart-a": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6 |
...
| `V0-INN-INTEROP` | a real INN server exchanges with an fn node as a third peer | **not-exercised** | accepted | - | - | KeyError: 'fn-post-supplied-path-240' |
| `V0-INN-FEED-OUT` | an article POSTed to fn reaches INN through fn's outbound feed (IHAVE 335/235) and nnrpd serves it changed only in Path and Xref | **not-exercised** | accepted | - | - | KeyError: 'fn-post-supplied-path-240' |
| `V0-INN-FEED-IN` | INN's innfeed delivers an article to fn (CHECK 238, TAKETHIS 239) and fn serves it changed at most in Path and Xref | **not-exercised** | accepted | - | - | KeyError: 'fn-post-supplied-path-240' |
| `V0-INN-DUPLICATE-INN` | INN refuses a second IHAVE of the article fn fed it with 435 | **not-exercised** | refused | - | - | KeyError: 'fn-post-supplied-path-240' |
| `V0-INN-DUPLICATE-FN` | fn refuses a second IHAVE of each article it holds (INN's and its own) with 435 | **not-exercised** | refused | - | - | KeyError: 'fn-post-supplied-path-240' |
| `V0-INN-LOOP-INN` | INN refuses an article whose Path names it with 437 | **not-exercised** | refused | - | - | KeyError: 'fn-post-supplied-path-240' |
| `V0-INN-LOOP-FN` | fn refuses an article whose Path names its own path identity, and does not serve it | **not-exercised** | refused | - | - | KeyError: 'fn-post-supplied-path-240' |
| `V0-INN-RESTART` | INN's history survives a SIGKILL of innd, and fn's articles survive a SIGTERM, recover and restart byte-identical | **not-exercised** | accepted | - | - | KeyError: 'fn-post-supplied-path-240' |
| `V0-INN-SERVING-AGENT` | an article fn took from INN is served with fn's path identity in Path and without INN's Xref (RFC 5537 3.7 steps 6 and 7) | **not-exercised** | accepted | - | - | KeyError: 'fn-post-supplied-path-240' |
| `V0-INN-OPERATOR-POST` | an article submitted through `operator post` reaches INN through fn's feed, injected with fn's Path (IHAVE 335/235) | **not-exercised** | accepted | - | - | KeyError: 'fn-post-supplied-path-240' |
...
- `V0-INN-INTEROP` (not-exercised): the lab wrote no findings ([Errno 2] No such file or directory: '/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.findings.json'): exit 1
- `V0-INN-FEED-OUT` (not-exercised): the lab wrote no findings ([Errno 2] No such file or directory: '/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.findings.json'): exit 1
- `V0-INN-FEED-IN` (not-exercised): the lab wrote no findings ([Errno 2] No such file or directory: '/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.findings.json'): exit 1
- `V0-INN-DUPLICATE-INN` (not-exercised): the lab wrote no findings ([Errno 2] No such file or directory: '/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.findings.json'): exit 1
- `V0-INN-DUPLICATE-FN` (not-exercised): the lab wrote no findings ([Errno 2] No such file or directory: '/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.findings.json'): exit 1
- `V0-INN-LOOP-INN` (not-exercised): the lab wrote no findings ([Errno 2] No such file or directory: '/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.findings.json'): exit 1
- `V0-INN-LOOP-FN` (not-exercised): the lab wrote no findings ([Errno 2] No such file or directory: '/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.findings.json'): exit 1
- `V0-INN-RESTART` (not-exercised): the lab wrote no findings ([Errno 2] No such file or directory: '/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.findings.json'): exit 1
- `V0-INN-SERVING-AGENT` (not-exercised): the lab wrote no findings ([Errno 2] No such file or directory: '/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.findings.json'): exit 1
- `V0-INN-OPERATOR-POST` (not-exercised): the lab wrote no findings ([Errno 2] No such file or directory: '/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.findings.json'): exit 1
...
- `V0-NODE-STOP-A`: `kill -TERM <owner pid> (harness) ; cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores`
- `V0-NODE-STOP-B`: `kill -TERM <owner pid> (harness) ; cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores`
...
- `V0-PEER-ABSENT`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores/a/fn.toml peer remove no-such-peer`
- `V0-PEER-REMOVE`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores/a/fn.toml peer remove b`
- `V0-CFG-LIVE`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores/a/fn.toml group create fn.matri...`
- `V0-CFG-LIVE-REFUSE`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator $HOME/fn-deploy/native-e747dbcc-d78ee77/a/offline/fn.toml group create fn.ma...`
...
- `V0-POST-OPEN-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --user '' --secret ''`
- `V0-POST-OPEN-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --user '' --secret ''`
- `V0-POST-COMMIT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --user '' --secret ''`
- `V0-POST-COMMIT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --user '' --secret ''`
- `V0-POST-READBACK-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --user '' --secret ''`
- `V0-POST-READBACK-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --user '' --secret ''`
- `V0-POST-FRESH-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --user '' --secret ''`
- `V0-POST-FRESH-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --user '' --secret ''`
- `V0-POST-DUPLICATE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --user '' --secret ''`
- `V0-POST-DUPLICATE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --user '' --secret ''`
- `V0-POST-CLOCK-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --user '' --secret ''`
- `V0-POST-CLOCK-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --user '' --secret ''`
- `V0-POST-FROM-MAILBOX-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --user '' --secret ''`
- `V0-POST-FROM-MAILBOX-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --user '' --secret ''`
- `V0-POST-CONCURRENT`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py concurrent --port 11190 --group fn.letters --msgid '<concurrent@example.invalid>' --user '' --secret ''`
- `V0-READ-CAPABILITIES-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-CAPABILITIES-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-MODE-READER-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-MODE-READER-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-ACTIVE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-ACTIVE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-NEWSGROUPS-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-NEWSGROUPS-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-NEWSGROUPS-WILDMAT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-NEWSGROUPS-WILDMAT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-OVERVIEW-FMT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-OVERVIEW-FMT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-ACTIVE-TIMES-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-ACTIVE-TIMES-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-HEADERS-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LIST-HEADERS-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-GROUP-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-GROUP-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LISTGROUP-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LISTGROUP-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HEAD-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HEAD-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-BODY-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-BODY-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-STAT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-STAT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-MSGID-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-MSGID-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-ABSENT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-ARTICLE-ABSENT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-OVER-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-OVER-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-OVER-RANGE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-OVER-RANGE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HDR-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HDR-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XOVER-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XOVER-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XHDR-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XHDR-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XPAT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-XPAT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEXT-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEXT-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LAST-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-LAST-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-STAMP-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-STAMP-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-FUTURE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-FUTURE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-SYNTAX-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-NEWNEWS-SYNTAX-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-DATE-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-DATE-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HELP-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-HELP-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-UNKNOWN-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-UNKNOWN-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-FRAMING-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-READ-FRAMING-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
- `V0-PIN-DISPATCHED-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py pins --port 11190 --group fn.letters --user '' --secret ''`
- `V0-PIN-DISPATCHED-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py pins --port 11191 --group fn.letters --user '' --secret ''`
- `V0-PIN-ADVERTISED-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py pins --port 11190 --group fn.letters --user '' --secret ''`
- `V0-PIN-ADVERTISED-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py pins --port 11191 --group fn.letters --user '' --secret ''`
...
- `V0-TRANSIT-MODE-STREAM-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11190 --to-port 11191 --msgid '<alpha@a.example.invalid>' --group fn.letters --loop-msgid '<loop-ab@example.invalid>' --loop-identity b.gate.example.invalid`
- `V0-TRANSIT-MODE-STREAM-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11191 --to-port 11190 --msgid '<beta@b.example.invalid>' --group fn.letters --loop-msgid '<loop-ba@example.invalid>' --loop-identity a.gate.example.invalid`
- `V0-TRANSIT-OFFER-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11190 --to-port 11191 --msgid '<alpha@a.example.invalid>' --group fn.letters --loop-msgid '<loop-ab@example.invalid>' --loop-identity b.gate.example.invalid`
- `V0-TRANSIT-OFFER-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11191 --to-port 11190 --msgid '<beta@b.example.invalid>' --group fn.letters --loop-msgid '<loop-ba@example.invalid>' --loop-identity a.gate.example.invalid`
- `V0-TRANSIT-TRANSFER-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11190 --to-port 11191 --msgid '<alpha@a.example.invalid>' --group fn.letters --loop-msgid '<loop-ab@example.invalid>' --loop-identity b.gate.example.invalid`
- `V0-TRANSIT-TRANSFER-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11191 --to-port 11190 --msgid '<beta@b.example.invalid>' --group fn.letters --loop-msgid '<loop-ba@example.invalid>' --loop-identity a.gate.example.invalid`
- `V0-TRANSIT-IDENTICAL-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11190 --to-port 11191 --msgid '<alpha@a.example.invalid>' --group fn.letters --loop-msgid '<loop-ab@example.invalid>' --loop-identity b.gate.example.invalid`
- `V0-TRANSIT-IDENTICAL-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11191 --to-port 11190 --msgid '<beta@b.example.invalid>' --group fn.letters --loop-msgid '<loop-ba@example.invalid>' --loop-identity a.gate.example.invalid`
- `V0-TRANSIT-DUPLICATE-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11190 --to-port 11191 --msgid '<alpha@a.example.invalid>' --group fn.letters --loop-msgid '<loop-ab@example.invalid>' --loop-identity b.gate.example.invalid`
- `V0-TRANSIT-DUPLICATE-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11191 --to-port 11190 --msgid '<beta@b.example.invalid>' --group fn.letters --loop-msgid '<loop-ba@example.invalid>' --loop-identity a.gate.example.invalid`
- `V0-TRANSIT-LOOP-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11190 --to-port 11191 --msgid '<alpha@a.example.invalid>' --group fn.letters --loop-msgid '<loop-ab@example.invalid>' --loop-identity b.gate.example.invalid`
- `V0-TRANSIT-LOOP-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11191 --to-port 11190 --msgid '<beta@b.example.invalid>' --group fn.letters --loop-msgid '<loop-ba@example.invalid>' --loop-identity a.gate.example.invalid`
- `V0-TRANSIT-LOOP-ABSENT-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11190 --to-port 11191 --msgid '<alpha@a.example.invalid>' --group fn.letters --loop-msgid '<loop-ab@example.invalid>' --loop-identity b.gate.example.invalid`
- `V0-TRANSIT-LOOP-ABSENT-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11191 --to-port 11190 --msgid '<beta@b.example.invalid>' --group fn.letters --loop-msgid '<loop-ba@example.invalid>' --loop-identity a.gate.example.invalid`
- `V0-TRANSIT-CHECK-FRESH-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py stream --from-port 11190 --to-port 11191 --msgid '<stream-a@example.invalid>'`
- `V0-TRANSIT-CHECK-FRESH-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py stream --from-port 11191 --to-port 11190 --msgid '<stream-b@example.invalid>'`
- `V0-TRANSIT-TAKETHIS-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py stream --from-port 11190 --to-port 11191 --msgid '<stream-a@example.invalid>'`
- `V0-TRANSIT-TAKETHIS-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py stream --from-port 11191 --to-port 11190 --msgid '<stream-b@example.invalid>'`
- `V0-TRANSIT-CHECK-DUP-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11190 --to-port 11191 --msgid '<alpha@a.example.invalid>' --group fn.letters --loop-msgid '<loop-ab@example.invalid>' --loop-identity b.gate.example.invalid`
- `V0-TRANSIT-CHECK-DUP-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11191 --to-port 11190 --msgid '<beta@b.example.invalid>' --group fn.letters --loop-msgid '<loop-ba@example.invalid>' --loop-identity a.gate.example.invalid`
- `V0-TRANSIT-TAKETHIS-DUP-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11190 --to-port 11191 --msgid '<alpha@a.example.invalid>' --group fn.letters --loop-msgid '<loop-ab@example.invalid>' --loop-identity b.gate.example.invalid`
- `V0-TRANSIT-TAKETHIS-DUP-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11191 --to-port 11190 --msgid '<beta@b.example.invalid>' --group fn.letters --loop-msgid '<loop-ba@example.invalid>' --loop-identity a.gate.example.invalid`
- `V0-TRANSIT-TLS-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; runtime_path=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0d...`
- `V0-TRANSIT-TLS-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; runtime_path=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0d...`
- `V0-TRANSIT-AUTHINFO-AB`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; runtime_path=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0d...`
- `V0-TRANSIT-AUTHINFO-BA`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; runtime_path=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0d...`
- `V0-TRANSIT-TLS-WRONG-ANCHOR`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; runtime_path=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0d...`
- `V0-TRANSIT-AUTHINFO-WRONG`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; runtime_path=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0d...`
- `V0-FEED-QUEUE`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; launcher_before=$(digest packaging/fn-native) ; runtime_before=$(digest "$image") ; co...`
- `V0-FEED-OFFER`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; launcher_before=$(digest packaging/fn-native) ; runtime_before=$(digest "$image") ; co...`
- `V0-FEED-ONCE`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; runtime_path=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0d...`
- `V0-FEED-JOURNAL`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; launcher_before=$(digest packaging/fn-native) ; runtime_before=$(digest "$image") ; co...`
...
- `V0-INN-INTEROP`: `/opt/homebrew/opt/python@3.14/bin/python3.14 /Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/tools/inn_lab.py d78ee77d8969e89c0996163c4001d30e73c6a95b --host hbox --native-image /tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host --native-openssl-prefix /tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/ope`
...
- `V0-CLIENT-NNTPLIB-A`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3.12 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>' --user '' --secret ''`
- `V0-CLIENT-NNTPLIB-B`: `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3.12 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>' --user '' --secret ''`
...
| 15 | loopback refusal: scratch store | 0 | `initialized /home/hbox/fn-deploy/native-e747dbcc-d78ee77/loopback/store` | 0.4 |
...
| 23 | node A profile service log | 0 | `accepted post path=control message-id=<profile-a@example.invalid> time=2026-09-25T20:05:17Z` | 0.2 |
...
| 33 | node B init scratch configuration | 0 | `MATRIX-CONFIG-STORE /home/hbox/fn-deploy/native-e747dbcc-d78ee77/b/init/store` | 0.3 |
...
| 46 | node A capacity scratch store | 0 | `initialized /home/hbox/fn-deploy/native-e747dbcc-d78ee77/a/capacity/store` | 0.5 |
...
| 66 | node B capacity scratch store | 0 | `initialized /home/hbox/fn-deploy/native-e747dbcc-d78ee77/b/capacity/store` | 0.4 |
...
| 74 | node B principal set-password matrix | 0 | `matrix principal=a51e6e0486cb040737b29d0d8d52465c8c850156ca110b9b23973c03a8cc1ac3 posting=true` | 0.4 |
...
| 77 | node B auth-required scratch credential | 0 | `matrix principal=a51e6e0486cb040737b29d0d8d52465c8c850156ca110b9b23973c03a8cc1ac3 posting=true` | 0.4 |
...
| 80 | stop server authgate-b | 0 | `stopped` | 1.6 |
...
| 96 | node A POST cycle | 0 | `{"GROUP BEFORE": "211 0 1 0 fn.letters", "POST": "340 send article to be posted", "COMMIT": "240 article received OK", "GROUP AFTER": "211 1 1 1 fn.letters", "FRESH ARTICLE": "220 0 <native-matrix-94c` | 0.4 |
...
| 113 | node B POST cycle | 0 | `{"GROUP BEFORE": "211 0 1 0 fn.letters", "POST": "340 send article to be posted", "COMMIT": "240 article received OK", "GROUP AFTER": "211 1 1 1 fn.letters", "FRESH ARTICLE": "220 0 <native-matrix-21f` | 1.5 |
...
| 120 | node B outcome accepted | 0 | `accepted operator post ACCEPTED` | 0.6 |
...
| 126 | node B seed <stream-b@example.invalid> | 0 | `accepted operator post ACCEPTED` | 0.8 |
| 127 | node A server is alive | 0 | `ALIVE` | 2.8 |
| 128 | node B server is alive | 0 | `ALIVE` | 3.1 |
| 129 | nntplib interpreter | 0 | `USE python3.12` | 1.8 |
| 130 | install independent.py | 0 | `` | 3.9 |
| 131 | independent nntplib client on node A | 0 | `{"absent": "430 no article with that message-id", "article_has_msgid": true, "article_lines": 10, "body_lines": 1, "capabilities": ["AUTHINFO", "HDR", "IHAVE", "IMPLEMENTATION", "LIST", "NEWNEWS", "OV` | 1.4 |
| 132 | independent nntplib client on node B | 0 | `/home/hbox/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py:6: DeprecationWarning: 'nntplib' is deprecated and slated for removal in Python 3.13` | 0.7 |
| 133 | tin home | 0 | `` | 0.3 |
| 134 | install .newsrc | 0 | `` | 0.2 |
| 135 | install editor.sh | 0 | `` | 0.3 |
| 136 | tin client | 0 | `1790366785.334 1 --- connection` | 73.4 |
...
| 149 | a second reader across node A's POST | 0 | `{"WATCHER BEFORE": "211 7 1 7 fn.letters", "POST": "340 send article to be posted", "WATCHER MID": "211 7 1 7 fn.letters", "WATCHER ARTICLE MID": "223 1 <native-matrix-94ca7a66d8e8-a@example.invalid> ` | 0.5 |
| 150 | node A server is alive | 0 | `ALIVE` | 0.3 |
| 151 | node B server is alive | 0 | `ALIVE` | 0.2 |
| 152 | live reconfiguration: declare fn.matrix.live on node A | 0 | `accepted operator group` | 0.7 |
| 153 | node A serves fn.matrix.live without a restart | 0 | `{"groups": {"fn.matrix.live": "211 0 1 0 fn.matrix.live"}, "present": {}, "absent": {}, "ok": true}` | 0.4 |
| 154 | node A server is alive | 0 | `ALIVE` | 0.4 |
| 155 | node A configured store | 0 | `/tank/fn/scratch/qual-e747dbcc/matrix/stores/a/store` | 0.2 |
| 156 | offline configuration over node A's store | 0 | `` | 0.4 |
| 157 | offline group create while the owner holds the store | 1 | `refused operator group store is already locked` | 0.5 |
| 158 | native public peering/restart witness | 0 | `NATIVE-PEERING-EXPECTED-RUNTIME b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5` | 5.0 |
...
| 161 | node A store after the stop | 0 | `transactions=8 articles=8 staging-orphans=0 unsigned-legacy-experiment` | 0.5 |
...
| 163 | node A log tail | 0 | `refused transit connection=40 message-id=<pin.take@matrix.example.invalid> code=439 decision=refuse reason=proto-article detail=none time=2026-09-25T20:07:40Z` | 0.2 |
| 164 | stop server node B (main) | 0 | `stopped` | 1.4 |
...
| 167 | node B log tail | 0 | `accepted peer connection=30 peer=a time=2026-09-25T20:07:41Z` | 0.3 |
...
| 170 | inn lab | 1 | `Traceback (most recent call last):` | 39.6 |
...
27. **install init.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/init/init.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG9uZSBkdXJhYmxlIG91dGNvbWUN ; Ck5ld3Nncm91cHM6IGZuLmxldHRlcnMNCkRhdGU6IEZyaSwgMjUgU2VwIDIwMjYgMjA6MDU6MjEg ; KzAwMDANCk1lc3NhZ2UtSUQ6IDxpbml0LWFAZXhhbXBsZS5pbnZhbGlkPg0KDQpTdWJtaXR0ZWQg ; b24gdGhlIEEgaW5pdCBzY3JhdGNoIG5vZGUgYnkgdGhlIHYwIG1hdHJpeC4NCg== ; FN_...`
...
36. **install init.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/b/init/init.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG9uZSBkdXJhYmxlIG91dGNvbWUN ; Ck5ld3Nncm91cHM6IGZuLmxldHRlcnMNCkRhdGU6IEZyaSwgMjUgU2VwIDIwMjYgMjA6MDU6MjQg ; KzAwMDANCk1lc3NhZ2UtSUQ6IDxpbml0LWJAZXhhbXBsZS5pbnZhbGlkPg0KDQpTdWJtaXR0ZWQg ; b24gdGhlIEIgaW5pdCBzY3JhdGNoIG5vZGUgYnkgdGhlIHYwIG1hdHJpeC4NCg== ; FN_...`
...
93. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
...
95. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
96. **node A POST cycle** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --user '' --secret ''`
97. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
98. **node A reader surface** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>'`
99. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
...
101. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
102. **install alpha.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/alpha.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; QQ0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDowNTo1 ; OCArMDAwMA0KTWVzc2FnZS1JRDogPGFscGhhQGEuZXhhbXBsZS5pbnZhbGlkPg0KDQpXcml0dGVu ; IG9uIG5vZGUgQSBieSB0aGUgdjAgbWF0cml4IHRocm91Z2ggdGhlIG5hdGl2ZSBvcGVyYXRvci...`
...
104. **install alpha.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/alpha.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; QQ0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDowNTo1 ; OCArMDAwMA0KTWVzc2FnZS1JRDogPGFscGhhQGEuZXhhbXBsZS5pbnZhbGlkPg0KDQpXcml0dGVu ; IG9uIG5vZGUgQSBieSB0aGUgdjAgbWF0cml4IHRocm91Z2ggdGhlIG5hdGl2ZSBvcGVyYXRvci...`
...
106. **install alpha-conflict.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/alpha-conflict.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; QQ0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDowNTo1 ; OCArMDAwMA0KTWVzc2FnZS1JRDogPGFscGhhQGEuZXhhbXBsZS5pbnZhbGlkPg0KDQpXcml0dGVu ; IG9uIG5vZGUgQSBieSB0aGUgdjAgbWF0cml4IHRocm91Z2ggdGhlIG5hdGl2ZSBvc...`
...
108. **install stream-a.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/stream-a.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IGZvciB0aGUgc3RyZWFtaW5nIG9m ; ZmVyDQpOZXdzZ3JvdXBzOiBmbi5sZXR0ZXJzDQpEYXRlOiBGcmksIDI1IFNlcCAyMDI2IDIwOjA2 ; OjAxICswMDAwDQpNZXNzYWdlLUlEOiA8c3RyZWFtLWFAZXhhbXBsZS5pbnZhbGlkPg0KDQpTZWVk ; ZWQgb24gbm9kZSBBIGJ5IHRoZSB2MCBtYXRyaXguDQo= ; FN_GATE_EOF ; chmod 644 ...`
...
110. **node B server is alive** -- `kill -0 3712827 2>/dev/null && echo ALIVE || echo DEAD`
...
112. **node B server is alive** -- `kill -0 3712827 2>/dev/null && echo ALIVE || echo DEAD`
113. **node B POST cycle** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py postcycle --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --user '' --secret ''`
114. **node B server is alive** -- `kill -0 3712827 2>/dev/null && echo ALIVE || echo DEAD`
115. **node B reader surface** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py surface --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>'`
116. **node B server is alive** -- `kill -0 3712827 2>/dev/null && echo ALIVE || echo DEAD`
...
118. **node B server is alive** -- `kill -0 3712827 2>/dev/null && echo ALIVE || echo DEAD`
119. **install beta.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/b/beta.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; Qg0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDowNjow ; NiArMDAwMA0KTWVzc2FnZS1JRDogPGJldGFAYi5leGFtcGxlLmludmFsaWQ+DQoNCldyaXR0ZW4g ; b24gbm9kZSBCIGJ5IHRoZSB2MCBtYXRyaXggdGhyb3VnaCB0aGUgbmF0aXZlIG9wZXJhdG9yLg0...`
...
121. **install beta.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/b/beta.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; Qg0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDowNjow ; NiArMDAwMA0KTWVzc2FnZS1JRDogPGJldGFAYi5leGFtcGxlLmludmFsaWQ+DQoNCldyaXR0ZW4g ; b24gbm9kZSBCIGJ5IHRoZSB2MCBtYXRyaXggdGhyb3VnaCB0aGUgbmF0aXZlIG9wZXJhdG9yLg0...`
...
123. **install beta-conflict.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/b/beta-conflict.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IG91dGNvbWUsIHdyaXR0ZW4gb24g ; Qg0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KRGF0ZTogRnJpLCAyNSBTZXAgMjAyNiAyMDowNjow ; NiArMDAwMA0KTWVzc2FnZS1JRDogPGJldGFAYi5leGFtcGxlLmludmFsaWQ+DQoNCldyaXR0ZW4g ; b24gbm9kZSBCIGJ5IHRoZSB2MCBtYXRyaXggdGhyb3VnaCB0aGUgbmF0aXZlIG9wZX...`
...
125. **install stream-b.article** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/b/stream-b.article <<'FN_GATE_EOF' ; RnJvbTogZ2F0ZUBleGFtcGxlLmludmFsaWQNClN1YmplY3Q6IGZvciB0aGUgc3RyZWFtaW5nIG9m ; ZmVyDQpOZXdzZ3JvdXBzOiBmbi5sZXR0ZXJzDQpEYXRlOiBGcmksIDI1IFNlcCAyMDI2IDIwOjA2 ; OjA4ICswMDAwDQpNZXNzYWdlLUlEOiA8c3RyZWFtLWJAZXhhbXBsZS5pbnZhbGlkPg0KDQpTZWVk ; ZWQgb24gbm9kZSBCIGJ5IHRoZSB2MCBtYXRyaXguDQo= ; FN_GATE_EOF ; chmod 644 ...`
...
127. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
128. **node B server is alive** -- `kill -0 3712827 2>/dev/null && echo ALIVE || echo DEAD`
...
131. **independent nntplib client on node A** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3.12 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py --port 11190 --group fn.letters --msgid '<native-matrix-94ca7a66d8e8-a@example.invalid>' --absent '<absent@example.invalid>' --user '' --secret ''`
132. **independent nntplib client on node B** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3.12 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py --port 11191 --group fn.letters --msgid '<native-matrix-21f50b37b6d3-b@example.invalid>' --absent '<absent@example.invalid>' --user '' --secret ''`
133. **tin home** -- `mkdir -p $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/tin-home`
134. **install .newsrc** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/tin-home/.newsrc <<'FN_GATE_EOF' ; Zm4ubGV0dGVyczoK ; FN_GATE_EOF ; chmod 644 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/tin-home/.newsrc`
135. **install editor.sh** -- `base64 -d > $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/tin-home/editor.sh <<'FN_GATE_EOF' ; IyEvYmluL3NoCnNsZWVwIDEuMgpmb3IgYTsgZG8gZj0kYTsgZG9uZQplY2hvICdhIGxpbmUgZnJv ; bSB0aW4gaW4gdGhlIHYwIG1hdHJpeCcgPj4gIiRmIgo= ; FN_GATE_EOF ; chmod 755 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/tin-home/editor.sh`
136. **tin client** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 tools/nntp_wire_log.py 11197 11190 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/tin-wire.log & relay=$!; sleep 1; TIN_FLAGS='-r' sh tools/tin_drive.sh /home/hbox/.cargo/bin/tin 11197 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/tin-home $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/tin-screens 'ENTER|3|group' 'ENTER|3|art...`
137. **node B server is alive** -- `kill -0 3712827 2>/dev/null && echo ALIVE || echo DEAD`
138. **transit AB: offer <alpha@a.example.invalid> from A to B** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11190 --to-port 11191 --msgid '<alpha@a.example.invalid>' --group fn.letters --loop-msgid '<loop-ab@example.invalid>' --loop-identity b.gate.example.invalid`
139. **transit AB: CHECK/TAKETHIS <stream-a@example.invalid> from A to B** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py stream --from-port 11190 --to-port 11191 --msgid '<stream-a@example.invalid>'`
140. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
141. **transit BA: offer <beta@b.example.invalid> from B to A** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py relay --from-port 11191 --to-port 11190 --msgid '<beta@b.example.invalid>' --group fn.letters --loop-msgid '<loop-ba@example.invalid>' --loop-identity a.gate.example.invalid`
142. **transit BA: CHECK/TAKETHIS <stream-b@example.invalid> from B to A** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py stream --from-port 11191 --to-port 11190 --msgid '<stream-b@example.invalid>'`
143. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
144. **node A capability pins** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py pins --port 11190 --group fn.letters --user '' --secret ''`
145. **node B server is alive** -- `kill -0 3712827 2>/dev/null && echo ALIVE || echo DEAD`
146. **node B capability pins** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py pins --port 11191 --group fn.letters --user '' --secret ''`
147. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
148. **node B server is alive** -- `kill -0 3712827 2>/dev/null && echo ALIVE || echo DEAD`
149. **a second reader across node A's POST** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/matrix.py concurrent --port 11190 --group fn.letters --msgid '<concurrent@example.invalid>' --user '' --secret ''`
150. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
151. **node B server is alive** -- `kill -0 3712827 2>/dev/null && echo ALIVE || echo DEAD`
152. **live reconfiguration: declare fn.matrix.live on node A** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores/a/fn.toml group create fn.matri...`
153. **node A serves fn.matrix.live without a restart** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; python3 $HOME/fn-deploy/native-e747dbcc-d78ee77/gate-run/feed.py presence --port 11190 --groups fn.matrix.live`
154. **node A server is alive** -- `kill -0 3712687 2>/dev/null && echo ALIVE || echo DEAD`
155. **node A configured store** -- `awk '/^\[/ {t=$0} t=="[store]" && /^path *=/ {sub(/^path *= *"/, ""); sub(/".*$/, ""); print; exit}' /tank/fn/scratch/qual-e747dbcc/matrix/stores/a/fn.toml`
156. **offline configuration over node A's store** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; mkdir -p $HOME/fn-deploy/native-e747dbcc-d78ee77/a/offline && printf '[store]\npath = "%s"\n[control]\npath = "%s"\n' /tank/fn/scratch/qual-e747dbcc/matrix/stores/a/store "$HOME/fn-deploy/native-e747dbcc-d78ee77/a/offline/never-bound.sock" > $HOME/fn-deploy/native-e747dbcc-d78ee77/a/offline/fn.toml`
157. **offline group create while the owner holds the store** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator $HOME/fn-deploy/native-e747dbcc-d78ee77/a/offline/fn.toml group create fn.ma...`
158. **native public peering/restart witness** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; launcher_before=$(digest packaging/fn-native) ; runtime_before=$(digest "$image") ; co...`
159. **native protected peering witness** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; image=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host ; digest() { ; if command -v sha256sum >/dev/null 2>&1; then sha256sum "$1" | awk '{print $1}' ; else shasum -a 256 "$1" | awk '{print $1}'; fi ; } ; runtime_path=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0d...`
160. **stop server node A (main)** -- `if [ -f $HOME/fn-deploy/native-e747dbcc-d78ee77/a/server.pid ]; then ; pid=$(cat $HOME/fn-deploy/native-e747dbcc-d78ee77/a/server.pid) ; kill $pid 2>/dev/null || true ; for i in $(seq 1 20); do kill -0 $pid 2>/dev/null || break; sleep 1; done ; kill -9 $pid 2>/dev/null || true ; rm -f $HOME/fn-deploy/native-e747dbcc-d78ee77/a/server.pid ; fi ; echo stopped`
161. **node A store after the stop** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores/a/fn.toml status`
162. **node A recover after the stop** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores/a/fn.toml recover`
163. **node A log tail** -- `tail -12 $HOME/fn-deploy/native-e747dbcc-d78ee77/a/server-a-main.log 2>/dev/null || echo NO-LOG`
164. **stop server node B (main)** -- `if [ -f $HOME/fn-deploy/native-e747dbcc-d78ee77/b/server.pid ]; then ; pid=$(cat $HOME/fn-deploy/native-e747dbcc-d78ee77/b/server.pid) ; kill $pid 2>/dev/null || true ; for i in $(seq 1 20); do kill -0 $pid 2>/dev/null || break; sleep 1; done ; kill -9 $pid 2>/dev/null || true ; rm -f $HOME/fn-deploy/native-e747dbcc-d78ee77/b/server.pid ; fi ; echo stopped`
165. **node B store after the stop** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores/b/fn.toml status`
166. **node B recover after the stop** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores/b/fn.toml recover`
167. **node B log tail** -- `tail -12 $HOME/fn-deploy/native-e747dbcc-d78ee77/b/server-b-main.log 2>/dev/null || echo NO-LOG`
168. **peer remove a peer that is not there** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores/a/fn.toml peer remove no-such-peer`
169. **peer remove the configured peer** -- `cd $HOME/fn-deploy/native-e747dbcc-d78ee77 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host packaging/fn-native operator /tank/fn/scratch/qual-e747dbcc/matrix/stores/a/fn.toml peer remove b`
170. **inn lab** -- `/opt/homebrew/opt/python@3.14/bin/python3.14 /Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/tools/inn_lab.py d78ee77d8969e89c0996163c4001d30e73c6a95b --host hbox --native-image /tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host --native-openssl-prefix /tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/openssl --evidence /Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/planning/evidence/v0-runs/20260925T200459.417716Z-d78ee77-fe5e6b741fdd/inn-lab.md`
171. **stop server node A (main)** -- `if [ -f $HOME/fn-deploy/native-e747dbcc-d78ee77/a/server.pid ]; then ; pid=$(cat $HOME/fn-deploy/native-e747dbcc-d78ee77/a/server.pid) ; kill $pid 2>/dev/null || true ; for i in $(seq 1 20); do kill -0 $pid 2>/dev/null || break; sleep 1; done ; kill -9 $pid 2>/dev/null || true ; rm -f $HOME/fn-deploy/native-e747dbcc-d78ee77/a/server.pid ; fi ; echo stopped`
172. **stop the tap in front of node A** -- `if [ -f $HOME/fn-deploy/native-e747dbcc-d78ee77/a/tap.pid ]; then ; pid=$(cat $HOME/fn-deploy/native-e747dbcc-d78ee77/a/tap.pid) ; kill $pid 2>/dev/null || true ; for i in $(seq 1 10); do kill -0 $pid 2>/dev/null || break; sleep 1; done ; kill -9 $pid 2>/dev/null || true ; rm -f $HOME/fn-deploy/native-e747dbcc-d78ee77/a/tap.pid ; fi ; echo stopped`
173. **stop server node B (main)** -- `if [ -f $HOME/fn-deploy/native-e747dbcc-d78ee77/b/server.pid ]; then ; pid=$(cat $HOME/fn-deploy/native-e747dbcc-d78ee77/b/server.pid) ; kill $pid 2>/dev/null || true ; for i in $(seq 1 20); do kill -0 $pid 2>/dev/null || break; sleep 1; done ; kill -9 $pid 2>/dev/null || true ; rm -f $HOME/fn-deploy/native-e747dbcc-d78ee77/b/server.pid ; fi ; echo stopped`
174. **stop the tap in front of node B** -- `if [ -f $HOME/fn-deploy/native-e747dbcc-d78ee77/b/tap.pid ]; then ; pid=$(cat $HOME/fn-deploy/native-e747dbcc-d78ee77/b/tap.pid) ; kill $pid 2>/dev/null || true ; for i in $(seq 1 10); do kill -0 $pid 2>/dev/null || break; sleep 1; done ; kill -9 $pid 2>/dev/null || true ; rm -f $HOME/fn-deploy/native-e747dbcc-d78ee77/b/tap.pid ; fi ; echo stopped`
175. **stray fn processes** -- `pgrep -f 'fn-deploy/native-e747dbcc-d78ee77' >/dev/null 2>&1 && echo STRAY || echo CLEAN`
176. **release deploy lock** -- `rmdir $HOME/fn-deploy/.locks/native-e747dbcc-d78ee77.lock`
...
accepted post path=control message-id=<profile-a@example.invalid> time=2026-09-25T20:05:17Z
...
{"GROUP BEFORE": "211 0 1 0 fn.letters", "POST": "340 send article to be posted", "COMMIT": "240 article received OK", "GROUP AFTER": "211 1 1 1 fn.letters", "FRESH ARTICLE": "220 0 <native-matrix-21f50b37b6d3-b@example.invalid> article follows", "DUPLICATE POST": "340 send article to be posted", "DUPLICATE": "441 posting failed; this article is already stored here", "DATE AFTER DUPLICATE": "111 20260925200604", "FROM POST": "340 send article to be posted", "FROM": "441 posting failed; From is not a valid mailbox list", "FROM ARTICLE": "430 no article with that message-id", "counted": true, "ok": true}
--- 114 node B server is alive (rc=0)
ALIVE
--- 115 node B reader surface (rc=0)
{"greeting": "200 fn-nntp experimental server ready", "CAPABILITIES": "101 capability list follows", "capability_lines": ["VERSION 2", "READER", "POST", "OVER MSGID", "HDR", "XPAT", "NEWNEWS", "LIST ACTIVE ACTIVE.TIMES COUNTS HEADERS NEWSGROUPS OVERVIEW.FMT", "IMPLEMENTATION fn-nntp-lab", "IHAVE", "STREAMING", "AUTHINFO USER"], "MODE READER": "200 posting allowed", "LIST ACTIVE": "215 list of active newsgroups follows", "LIST NEWSGROUPS": "215 list of newsgroups follows", "LIST OVERVIEW.FMT": "215 order of fields in overview database", "LIST ACTIVE.TIMES": "215 information follows", "LIST HEADERS": "215 field list follows", "LIST NEWSGROUPS WILDMAT": "215 list of newsgroups follows", "GROUP": "211 1 1 1 fn.letters", "group_count": 1, "group_first": 1, "group_last": 1, "LISTGROUP": "211 1 1 1 fn.letters list follows", "ARTICLE": "220 1 <native-matrix-21f50b37b6d3-b@example.invalid> article follows", "HEAD": "221 1 <native-matrix-21f50b37b6d3-b@example.invalid> headers follow", "BODY": "222 1 <native-matrix-21f50b37b6d3-b@example.invalid> body follows", "STAT": "223 1 <native-matrix-21f50b37b6d3-b@example.invalid> retrieved", "ARTICLE MSGID": "220 1 <native-matrix-21f50b37b6d3-b@example.invalid> article follows", "ARTICLE ABSENT": "430 no article with that message-id", "OVER": "224 overview information follows", "OVER RANGE": "224 overview information follows", "HDR": "225 headers follow", "XOVER": "224 overview information follows", "XHDR": "221 header follows", "XPAT": "221 header follows", "NEWNEWS": "230 list of new articles by message-id follows", "NEWNEWS STAMP TARGET": true, "NEWNEWS FUTURE": "230 list of new articles by message-id follows", "NEWNEWS SYNTAX": "501 syntax error", "NEXT": "421 no next article", "LAST": "422 no previous article", "DATE": "111 20260925200605", "HELP": "100 help text follows", "UNKNOWN": "500 command not recognized", "FRAMING": "111 20260925200605", "FRAMING SAME": true, "ok": true}
...
/home/hbox/fn-deploy/native-e747dbcc-d78ee77/gate-run/independent.py:6: DeprecationWarning: 'nntplib' is deprecated and slated for removal in Python 3.13
  import argparse, json, nntplib, platform, sys
{"absent": "430 no article with that message-id", "article_has_msgid": true, "article_lines": 10, "body_lines": 1, "capabilities": ["AUTHINFO", "HDR", "IHAVE", "IMPLEMENTATION", "LIST", "NEWNEWS", "OVER", "POST", "READER", "STREAMING", "VERSION", "XPAT"], "client": "stdlib nntplib", "commands": ["CAPABILITIES", "GROUP", "STAT", "ARTICLE", "HEAD", "BODY", "OVER", "LIST", "ARTICLE (absent)", "QUIT"], "group": {"count": 4, "first": 1, "last": 4, "name": "fn.letters"}, "head_lines": 8, "list_groups": ["fn.letters", "fn.matrix", "fn.matrix.throwaway"], "ok": true, "over_rows": 4, "python": "3.12.7", "quit": "205 closing connection", "stat": [1, "<native-matrix-21f50b37b6d3-b@example.invalid>"], "welcome": "200 fn-nntp experimental server ready"}
--- 133 tin home (rc=0)
--- 134 install .newsrc (rc=0)
--- 135 install editor.sh (rc=0)
--- 136 tin client (rc=0)
1790366785.334 1 --- connection
1790366785.335 1 S: 200 fn-nntp experimental server ready
1790366785.335 1 C: CAPABILITIES
1790366785.335 1 S: 101 capability list follows
1790366785.335 1 S: VERSION 2
1790366785.335 1 S: READER
1790366785.335 1 S: POST
1790366785.335 1 S: OVER MSGID
1790366785.335 1 S: HDR
1790366785.335 1 S: XPAT
1790366785.335 1 S: NEWNEWS
1790366785.335 1 S: LIST ACTIVE ACTIVE.TIMES COUNTS HEADERS NEWSGROUPS OVERVIEW.FMT
--- 137 node B server is alive (rc=0)
ALIVE
--- 138 transit AB: offer <alpha@a.example.invalid> from A to B (rc=1)
{"msgid": "<alpha@a.example.invalid>", "source": "220 0 <alpha@a.example.invalid> article follows", "source_lines": 9, "capabilities": ["VERSION 2", "READER", "POST", "OVER MSGID", "HDR", "XPAT", "NEWNEWS", "LIST ACTIVE ACTIVE.TIMES COUNTS HEADERS NEWSGROUPS OVERVIEW.FMT", "IMPLEMENTATION fn-nntp-lab", "IHAVE", "STREAMING", "AUTHINFO USER"], "ihave_advertised": true, "streaming_advertised": true, "mode_stream": "203 streaming permitted", "offer": "335 send it; end with <CR-LF>.<CR-LF>", "transit": true, "transfer": "235 article transferred OK", "duplicate": "435 duplicate", "loop_offer": "335 send it; end with <CR-LF>.<CR-LF>", "loop_result": "437 transfer rejected; path loop", "check_duplicate": "438 <alpha@a.example.invalid>", "takethis_duplicate": "439 <alpha@a.example.invalid>", "check_fresh": "238 <fresh.check@gate.example.invalid>", "reread": "220 0 <alpha@a.example.invalid> article follows", "identical": false, "sent_lines": ["Path: a.gate.example.invalid!not-for-mail", "Injection-Info: a.gate.example.invalid", "From: gate@example.invalid", "Subject: outcome, written on A", "Newsgroups: fn.letters", "Date: Fri, 25 Sep 2026 20:05:58 +0000", "Message-ID: <alpha@a.example.invalid>", "", "Written on node A by the v0 matrix through the native operator."], "reread_lines": ["Path: b.gate.example.invalid!!a.gate.example.invalid!not-for-mail", "Injection-Info: a.gate.example.invalid", "From: gate@example.invalid", "Subject: outcome, written on A", "Newsgroups: fn.letters", "Date: Fri, 25 Sep 2026 20:05:58 +0000", "Message-ID: <alpha@a.example.invalid>", "", "Written on node A by the v0 matrix through the native operator."], "loop_absent": "430 no article with that message-id", "streaming_ok": true, "ok": false}
...
{"WATCHER BEFORE": "211 7 1 7 fn.letters", "POST": "340 send article to be posted", "WATCHER MID": "211 7 1 7 fn.letters", "WATCHER ARTICLE MID": "223 1 <native-matrix-94ca7a66d8e8-a@example.invalid> retrieved", "COMMIT": "240 article received OK", "WATCHER AFTER": "211 7 1 7 fn.letters", "ok": true}
...
/tank/fn/scratch/qual-e747dbcc/matrix/stores/a/store
...
NATIVE-PEERING-EXPECTED-CORE 0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08
...
test_durable_feed_requeues_after_source_process_death (tests.test_native_peering.NativePeeringTests.test_durable_feed_requeues_after_source_process_death) ... native-peering launcher-sha256=432622d29a28d59455e01f3e5b426036c5862db21d5f7d1205a9304ab11e3505 core-sha256=0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08 declared-source=e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6
NATIVE-PEERING-WITNESS {"feed": {"ab": {"duplicate": "435", "identical": true}, "ba": {"duplicate": "435", "identical": true}}, "identity": {"a": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}, "b": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}}, "kind": "transit-and-feed", "transit": {"ab": {"duplicate": "435", "identical": true, "offer": "335", "transfer": "235"}, "ba": {"duplicate": "435", "identical": true, "offer": "335", "transfer": "235"}}}
NATIVE-PEERING-WITNESS {"duplicate": "435", "identity": {"restart-a": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}, "restart-b": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}}, "journal": true, "kind": "requeue-restart", "source_killed": true, "source_restarted": true, "target_identical": true}
ok

----------------------------------------------------------------------
Ran 2 tests in 4.038s
...
NATIVE-PROTECTED-EXPECTED-CORE 0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08
NATIVE-PROTECTED-EXPECTED-DEVELOPER-CORE 5889c6fb30c2589e05c2b293769bb1a11734e7ae5710cb49dc2d1a0dc78fc109
test_reciprocal_starttls_authinfo_transfer_and_reconnect (tests.test_native_protected_peering.NativeProtectedPeeringTests.test_reciprocal_starttls_authinfo_transfer_and_reconnect) ... native-protected-peering launcher-sha256=432622d29a28d59455e01f3e5b426036c5862db21d5f7d1205a9304ab11e3505 core-sha256=0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08 source=e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6
NATIVE-PROTECTED-WITNESS {"auth": "authinfo", "identity": {"a": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}, "b": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}}, "kind": "protected-feed", "reconnect": {"ab": {"identical": true}, "ba": {"identical": true}}, "security": "starttls", "target_policy": {"protected_only": true, "required": true}, "transit": {"ab": {"identical": true, "unauthenticated_offer": "502 transit is not permitted on this connection"}, "ba": {"identical": true, "unauthenticated_offer": "502 transit is not permitted on this connection"}}}
ok
test_bad_outbound_password_yields_authenticated_430_observation (tests.test_native_protected_peering.NativeProtectedPeeringTests.test_bad_outbound_password_yields_authenticated_430_observation) ... NATIVE-PROTECTED-WITNESS {"case": "wrong-password", "delivered": false, "identity": {"a": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}, "b": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}}, "kind": "protected-refusal", "source_alive": true, "target_alive": true}
ok
test_untrusted_certificate_yields_430_and_feed_journal_evidence (tests.test_native_protected_peering.NativeProtectedPeeringTests.test_untrusted_certificate_yields_430_and_feed_journal_evidence) ... NATIVE-PROTECTED-WITNESS {"case": "wrong-anchor", "delivered": false, "identity": {"a": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}, "b": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}}, "journal": true, "kind": "protected-refusal", "source_alive": true, "target_alive": true}
ok
test_acknowledged_protected_feed_does_not_reoffer_after_source_death (tests.test_native_protected_peering.NativeProtectedPeeringTests.test_acknowledged_protected_feed_does_not_reoffer_after_source_death) ... NATIVE-PROTECTED-WITNESS {"after": {"attempts": 0, "inflight": "nil", "next_attempt": 2, "queue_length": 1, "records": {"feed-commit": 1, "feed-intent": 1, "feed-offer": 1, "feed-outcome": 1, "feed-restart": 2, "feed-sent": 1}, "sent_before_restart": "nil", "state_after_restart": "done", "state_before_restart": "done"}, "auth": "authinfo", "before": {"attempts": 0, "inflight": "nil", "next_attempt": 2, "queue_length": 1, "records": {"feed-commit": 1, "feed-intent": 1, "feed-offer": 1, "feed-outcome": 1, "feed-restart": 1, "feed-sent": 1}, "sent_before_restart": "nil", "state_after_restart": "done", "state_before_restart": "done"}, "identity": {"a": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}, "b": {"core": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/fn-host.core", "core_sha256": "0c96e554fae5ed7345b6ac2be89a9975430e879afae0ba5ccb072720dbd38d08", "runtime": "/tank/fn/gates/qual-e747dbcc-20260925/build/images/e747dbcc7f9f4ba6d86e0dc3ec8856a06f1994e6/runtime/sbcl", "runtime_sha256": "b115fe956aadee603459fac401e1ff2cc39321e14848544a0fe438788a2fc6d5", "status": "observed"}}, "kind": "feed-once", "recipient_articles": 1, "security": "starttls", "source_killed": true, "source_restarted": true}
ok
...
refused transit connection=40 message-id=<pin.take@matrix.example.invalid> code=439 decision=refuse reason=proto-article detail=none time=2026-09-25T20:07:40Z
accepted peer connection=41 peer=b time=2026-09-25T20:07:42Z
accepted peer connection=42 peer=b time=2026-09-25T20:07:42Z

ACL2 Warning [Invariant-risk] in FN-OWNER-SUBJECT-ID-BUFFER:  Invariant-
risk has been detected for a call of function FN-OWNER-SUBJECT-ID-BUFFER
(as possibly leading to an ill-guarded call of FN-SHS-W-SET); see :DOC
invariant-risk.

accepted post path=served connection=42 message-id=<concurrent@example.invalid> agent=a.gate.example.invalid time=2026-09-25T20:07:42Z
accepted peer connection=44 peer=b time=2026-09-25T20:07:44Z
...
accepted peer connection=30 peer=a time=2026-09-25T20:07:41Z
accepted peer connection=31 peer=a time=2026-09-25T20:07:41Z
accepted peer connection=32 peer=a time=2026-09-25T20:07:41Z
accepted peer connection=33 peer=a time=2026-09-25T20:07:41Z
accepted peer connection=34 peer=a time=2026-09-25T20:07:41Z
accepted peer connection=35 peer=a time=2026-09-25T20:07:41Z
accepted peer connection=36 peer=a time=2026-09-25T20:07:41Z
accepted peer connection=37 peer=a time=2026-09-25T20:07:41Z
accepted peer connection=38 peer=a time=2026-09-25T20:07:41Z
accepted peer connection=39 peer=a time=2026-09-25T20:07:41Z
refused transit connection=39 message-id=<pin.take@matrix.example.invalid> code=439 decision=refuse reason=proto-article detail=none time=2026-09-25T20:07:41Z
accepted operator run
...
Traceback (most recent call last):
  File "/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/tools/inn_lab.py", line 1987, in <module>
    sys.exit(main())
             ~~~~^^
  File "/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/tools/inn_lab.py", line 1964, in main
    lab.execute()
    ~~~~~~~~~~~^^
  File "/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/tools/inn_lab.py", line 1860, in execute
    self.scenario_supplied_path()
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~^^
  File "/Users/ember/dev/fn/build/lanes/qual-e747dbcc-lane/tools/inn_lab.py", line 1517, in scenario_supplied_path
