...
| inn server | innd pid 1278343 on port 11419, nnrpd on port 11420 |
| fn node | native owner pid 1284073 on port 11490 (after-term), store $HOME/fn-inn-lab/dev-c7665e7/node/store |
...
| fn post | POST='340 send article to be posted' article='240 article received OK' ARTICLE='220 0 <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> article follows' |
| fn feed to inn | IHAVE: 335 Send it / 235 Article transferred OK; the octets fed are identical to what fn serves |
| inn read of fn's article | GROUP='211 79 1 79 fn.letters' ARTICLE='220 0 <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> article' absent='430 No such article' |
...
| fn served vs inn served | changed: path; only in the second: xref; body identical; Path fn=`fnA.hbox.test!not-for-mail` inn=`inn.hbox.test!fnA.hbox.test!not-for-mail`; Xref inn=`inn.hbox.test fn.letters:79` |
...
| inn control | MODE STREAM='203 Streaming permitted' IHAVE='335 Send it' transfer='235 Article transferred OK' duplicate='435 Duplicate' loop='437 Unwanted site inn.hbox.test in path' CHECK(new)='238 <inn-lab-absent-c7665e7-20260926T100341Z@example.invalid> Send it' CHECK(dup)='438 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> Duplicate' |
| innfeed to fn | CHECK+TAKETHIS: 238 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> / 239 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> |
| inn served vs fn served | changed: path; only in the first: xref; body identical; Path inn=`inn.hbox.test!lab.example.invalid!not-for-mail` fn=`fnA.hbox.test!!inn.hbox.test!lab.example.invalid!not-for-mail`; Xref inn=`inn.hbox.test fn.letters:82` fn=`` |
...
| fn post supplied path | POST='340 send article to be posted' article='240 article received OK' ARTICLE='220 0 <inn-lab-fn-path-c7665e7-20260926T100341Z@example.invalid> article follows' |
...
| 9 | fn store init | 0 | `initialized /home/hbox/fn-inn-lab/dev-c7665e7/node/store` | 0.4 |
...
| 30 | start innd | 0 | `INND-UP pid=1278343` | 1.2 |
...
| 35 | start nnrpd | 0 | `NNRPD-UP pid=1279720` | 0.3 |
| 36 | start the relay | 0 | `TAP-UP pid=1279826` | 1.3 |
...
| 40 | POST <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> to the fn owner | 0 | `{"greeting": "200 fn-nntp experimental server ready", "post": "340 send article to be posted", "result": "240 article received OK", "article": "220 0 <inn-lab-fn-post-c7665e7-20260926T100341Z@example.` | 0.3 |
| 41 | relay log: fn's feed offers <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> to innd | 0 | `IHAVE on 11418>11419: 335 Send it / 235 Article transferred OK` | 0.2 |
| 42 | read <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> back from INN's nnrpd | 0 | `{"greeting": "200 inn.hbox.test InterNetNews NNRP server INN 2.7.4 ready (posting ok)", "group": "211 79 1 79 fn.letters", "article": "220 0 <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> ` | 0.3 |
| 43 | IHAVE <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> into innd again | 0 | `{"greeting": "200 inn.hbox.test InterNetNews server INN 2.7.4 ready (transit mode)", "offer": "435 Duplicate", "result": "", "ok": true}` | 0.3 |
| 44 | install fn-operator.article | 0 | `` | 0.2 |
| 45 | operator post <inn-lab-fn-operator-c7665e7-20260926T100341Z@example.invalid> | 0 | `accepted operator post ACCEPTED` | 0.3 |
| 46 | relay log: fn's feed offers <inn-lab-fn-operator-c7665e7-20260926T100341Z@example.invalid> to innd | 0 | `IHAVE on 11418>11419: 335 Send it / 235 Article transferred OK` | 0.2 |
| 47 | install fn-from.article | 0 | `` | 0.2 |
| 48 | POST <inn-lab-fn-from-c7665e7-20260926T100341Z@example.invalid> (From: yue) to the fn owner | 1 | `{"greeting": "200 fn-nntp experimental server ready", "post": "340 send article to be posted", "result": "441 posting failed; From is not a valid mailbox list", "article": "430 no article with that me` | 0.2 |
| 49 | install fn-path.article | 0 | `` | 0.2 |
| 50 | POST <inn-lab-fn-path-c7665e7-20260926T100341Z@example.invalid> (Path: not-for-mail) to the fn owner | 0 | `{"greeting": "200 fn-nntp experimental server ready", "post": "340 send article to be posted", "result": "240 article received OK", "article": "220 0 <inn-lab-fn-path-c7665e7-20260926T100341Z@example.` | 0.3 |
| 51 | install fed.article | 0 | `` | 0.2 |
| 52 | install inn-loop.article | 0 | `` | 0.2 |
| 53 | IHAVE <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> into innd | 0 | `{"greeting": "200 inn.hbox.test InterNetNews server INN 2.7.4 ready (transit mode)", "mode_stream": "203 Streaming permitted", "offer": "335 Send it", "transfer": "235 Article transferred OK", "duplic` | 0.3 |
| 54 | INN history for <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> | 0 | `@050000000007000000000000005200000000@` | 0.3 |
| 55 | ctlinnd flush fn | 0 | `Ok` | 0.2 |
| 56 | relay log: innfeed offers <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> to fn | 0 | `CHECK+TAKETHIS on 11417>11490: 238 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> / 239 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>` | 0.2 |
| 57 | innfeed log | 0 | `2026-09-26T06:04:04.726956-04:00 hbox innfeed[1278349]: ME finishing at Sat Sep 26 06:04:04 2026` | 0.3 |
| 58 | read <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> back from the fn owner | 0 | `{"greeting": "200 fn-nntp experimental server ready", "article": "220 0 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "UGF0aDogZm5BLmhib3gudGVzdCEhaW5uLmhib3gudGVz` | 0.3 |
| 59 | read <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> back from INN's nnrpd | 0 | `{"greeting": "200 inn.hbox.test InterNetNews NNRP server INN 2.7.4 ready (posting ok)", "group": "211 82 1 82 fn.letters", "article": "220 0 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> arti` | 0.3 |
| 60 | IHAVE <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> to fn again | 0 | `{"greeting": "200 fn-nntp experimental server ready", "offer": "435 duplicate", "result": "", "after": "220 0 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "UGF0aD` | 0.2 |
| 61 | IHAVE <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> to fn again | 0 | `{"greeting": "200 fn-nntp experimental server ready", "offer": "435 duplicate", "result": "", "after": "220 0 <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "UG` | 0.3 |
| 62 | install fn-loop.article | 0 | `` | 0.2 |
| 63 | IHAVE <inn-lab-fn-loop-c7665e7-20260926T100341Z@example.invalid> (Path names fnA.hbox.test) to fn | 0 | `{"greeting": "200 fn-nntp experimental server ready", "offer": "335 send it; end with <CR-LF>.<CR-LF>", "result": "437 transfer rejected; path loop", "after": "430 no article with that message-id", "o` | 0.3 |
| 64 | SIGTERM the fn owner | 0 | `OWNER-GONE` | 1.2 |
| 65 | innd survived the fn owner's stop | 0 | `Server running` | 0.2 |
| 66 | owner log (main) | 0 | `accepted peer connection=3 peer=inn time=2026-09-26T10:04:13Z` | 0.2 |
...
| 70 | reread <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> from fn after the restart | 0 | `{"greeting": "200 fn-nntp experimental server ready", "article": "220 0 <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "UGF0aDogZm5BLmhib3gudGVzdCFub3QtZm9yLW1h` | 0.2 |
| 71 | reread <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> from fn after the restart | 0 | `{"greeting": "200 fn-nntp experimental server ready", "article": "220 0 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "UGF0aDogZm5BLmhib3gudGVzdCEhaW5uLmhib3gudGVz` | 0.2 |
| 72 | kill -9 innd | 0 | `INND-GONE` | 0.2 |
| 73 | restart innd after the kill | 0 | `INND-UP pid=1284735` | 1.2 |
| 74 | after innd's restart, IHAVE <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> | 0 | `{"greeting": "200 inn.hbox.test InterNetNews server INN 2.7.4 ready (transit mode)", "offer": "435 Duplicate", "result": "", "ok": true}` | 0.2 |
| 75 | after innd's restart, IHAVE <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> | 0 | `{"greeting": "200 inn.hbox.test InterNetNews server INN 2.7.4 ready (transit mode)", "offer": "435 Duplicate", "result": "", "ok": true}` | 0.2 |
...
39. **install fn-post.article** -- `base64 -d > $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-post.article <<'FN_GATE_EOF' ; RnJvbTogbGFiQGV4YW1wbGUuaW52YWxpZA0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KU3ViamVj ; dDogcG9zdGVkIG9uIGZuLCBmZWQgdG8gSU5ODQpEYXRlOiBTYXQsIDI2IFNlcCAyMDI2IDEwOjAz ; OjQxIC0wMDAwDQpNZXNzYWdlLUlEOiA8aW5uLWxhYi1mbi1wb3N0LWM3NjY1ZTctMjAyNjA5MjZU ; MTAwMzQxWkBleGFtcGxlLmludmFsaWQ+DQoNCkZyb20gdGhlIGZuIElOTiBpbnRlcm9wIGxhYi4N...`
40. **POST <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> to the fn owner** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py post --port 11490 --msgid '<inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid>' --file $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-post.article`
41. **relay log: fn's feed offers <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> to innd** -- `cat $HOME/fn-inn-lab/dev-c7665e7/gate-run/tap.log (polled 1 times, pair 11418>11419)`
42. **read <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> back from INN's nnrpd** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py read --port 11420 --group fn.letters --msgid '<inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid>' --absent '<inn-lab-absent-c7665e7-20260926T100341Z@example.invalid>'`
43. **IHAVE <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> into innd again** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py offer --port 11419 --msgid '<inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid>' --file $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-post.article`
44. **install fn-operator.article** -- `base64 -d > $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-operator.article <<'FN_GATE_EOF' ; RnJvbTogbGFiQGV4YW1wbGUuaW52YWxpZA0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KU3ViamVj ; dDogc3VibWl0dGVkIHRocm91Z2ggb3BlcmF0b3IgcG9zdA0KRGF0ZTogU2F0LCAyNiBTZXAgMjAy ; NiAxMDowMzo0MSAtMDAwMA0KTWVzc2FnZS1JRDogPGlubi1sYWItZm4tb3BlcmF0b3ItYzc2NjVl ; Ny0yMDI2MDkyNlQxMDAzNDFaQGV4YW1wbGUuaW52YWxpZD4NCg0KRnJvbSB0aGUgZm4gSU5O...`
45. **operator post <inn-lab-fn-operator-c7665e7-20260926T100341Z@example.invalid>** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; env FN_OPENSSL_PREFIX=/tank/fn/gates/qual-b6759850-20260926/build/images/b675985074cf14b009204f6eb3e5409f4a025a80/openssl FN_NATIVE_HOST=/tank/fn/gates/qual-b6759850-20260926/build/images/b675985074cf14b009204f6eb3e5409f4a025a80/fn-host-developer packaging/fn-native operator $HOME/fn-inn-lab/dev-c7665e7/node/fn.toml post --message-id '<inn-lab-fn-oper...`
46. **relay log: fn's feed offers <inn-lab-fn-operator-c7665e7-20260926T100341Z@example.invalid> to innd** -- `cat $HOME/fn-inn-lab/dev-c7665e7/gate-run/tap.log (polled 1 times, pair 11418>11419)`
47. **install fn-from.article** -- `base64 -d > $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-from.article <<'FN_GATE_EOF' ; RnJvbTogeXVlDQpOZXdzZ3JvdXBzOiBmbi5sZXR0ZXJzDQpTdWJqZWN0OiBhIEZyb20gdGhhdCBu ; YW1lcyBubyBhZGRyZXNzDQpEYXRlOiBTYXQsIDI2IFNlcCAyMDI2IDEwOjAzOjQxIC0wMDAwDQpN ; ZXNzYWdlLUlEOiA8aW5uLWxhYi1mbi1mcm9tLWM3NjY1ZTctMjAyNjA5MjZUMTAwMzQxWkBleGFt ; cGxlLmludmFsaWQ+DQoNCkZyb20gdGhlIGZuIElOTiBpbnRlcm9wIGxhYi4NCg== ; FN_GATE_E...`
48. **POST <inn-lab-fn-from-c7665e7-20260926T100341Z@example.invalid> (From: yue) to the fn owner** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py post --port 11490 --msgid '<inn-lab-fn-from-c7665e7-20260926T100341Z@example.invalid>' --file $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-from.article`
49. **install fn-path.article** -- `base64 -d > $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-path.article <<'FN_GATE_EOF' ; UGF0aDogbm90LWZvci1tYWlsDQpGcm9tOiBsYWJAZXhhbXBsZS5pbnZhbGlkDQpOZXdzZ3JvdXBz ; OiBmbi5sZXR0ZXJzDQpTdWJqZWN0OiBhIFBhdGggdGhlIHBvc3RpbmcgYWdlbnQgc3VwcGxpZWQN ; CkRhdGU6IFNhdCwgMjYgU2VwIDIwMjYgMTA6MDM6NDEgLTAwMDANCk1lc3NhZ2UtSUQ6IDxpbm4t ; bGFiLWZuLXBhdGgtYzc2NjVlNy0yMDI2MDkyNlQxMDAzNDFaQGV4YW1wbGUuaW52YWxpZD4NCg0K...`
50. **POST <inn-lab-fn-path-c7665e7-20260926T100341Z@example.invalid> (Path: not-for-mail) to the fn owner** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py post --port 11490 --msgid '<inn-lab-fn-path-c7665e7-20260926T100341Z@example.invalid>' --file $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-path.article`
51. **install fed.article** -- `base64 -d > $HOME/fn-inn-lab/dev-c7665e7/gate-run/fed.article <<'FN_GATE_EOF' ; UGF0aDogbGFiLmV4YW1wbGUuaW52YWxpZCFub3QtZm9yLW1haWwNCkZyb206IGxhYkBleGFtcGxl ; LmludmFsaWQNCk5ld3Nncm91cHM6IGZuLmxldHRlcnMNClN1YmplY3Q6IGhhbmRlZCB0byBJTk4s ; IGZlZCBvbiB0byBmbg0KRGF0ZTogU2F0LCAyNiBTZXAgMjAyNiAxMDowMzo0MSAtMDAwMA0KTWVz ; c2FnZS1JRDogPGlubi1sYWItZmVkLWM3NjY1ZTctMjAyNjA5MjZUMTAwMzQxWkBleGFtcGxlLmlu ; d...`
52. **install inn-loop.article** -- `base64 -d > $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn-loop.article <<'FN_GATE_EOF' ; UGF0aDogaW5uLmhib3gudGVzdCFsYWIuZXhhbXBsZS5pbnZhbGlkIW5vdC1mb3ItbWFpbA0KRnJv ; bTogbGFiQGV4YW1wbGUuaW52YWxpZA0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KU3ViamVjdDog ; YSBQYXRoIHRoYXQgbmFtZXMgSU5ODQpEYXRlOiBTYXQsIDI2IFNlcCAyMDI2IDEwOjAzOjQxIC0w ; MDAwDQpNZXNzYWdlLUlEOiA8aW5uLWxhYi1sb29wLWM3NjY1ZTctMjAyNjA5MjZUMTAwMzQxWkB...`
53. **IHAVE <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> into innd** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py ihave --port 11419 --msgid '<inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>' --file $HOME/fn-inn-lab/dev-c7665e7/gate-run/fed.article --loop-msgid '<inn-lab-loop-c7665e7-20260926T100341Z@example.invalid>' --loop-file $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn-loop.article --absent '<inn-lab-ab...`
54. **INN history for <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>** -- `/tank/fn/inn/2.7.4/bin/grephistory '<inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>' 2>&1 | head -3`
55. **ctlinnd flush fn** -- `/tank/fn/inn/2.7.4/bin/ctlinnd -t 10 flush fn 2>&1 || true`
56. **relay log: innfeed offers <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> to fn** -- `cat $HOME/fn-inn-lab/dev-c7665e7/gate-run/tap.log (polled 1 times, pair 11417>11490)`
57. **innfeed log** -- `tail -20 /tank/fn/inn/2.7.4/log/innfeed.log 2>/dev/null; grep -h 'innfeed' /var/log/syslog 2>/dev/null | tail -8 || true`
58. **read <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> back from the fn owner** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py fetch --port 11490 --msgid '<inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>'`
59. **read <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> back from INN's nnrpd** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py read --port 11420 --group fn.letters --msgid '<inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>' --absent '<inn-lab-absent-c7665e7-20260926T100341Z@example.invalid>'`
60. **IHAVE <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> to fn again** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py offer --port 11490 --msgid '<inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>' --file $HOME/fn-inn-lab/dev-c7665e7/gate-run/fed.article --read`
61. **IHAVE <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> to fn again** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py offer --port 11490 --msgid '<inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid>' --file $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-post.article --read`
62. **install fn-loop.article** -- `base64 -d > $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-loop.article <<'FN_GATE_EOF' ; UGF0aDogZm5BLmhib3gudGVzdCFsYWIuZXhhbXBsZS5pbnZhbGlkIW5vdC1mb3ItbWFpbA0KRnJv ; bTogbGFiQGV4YW1wbGUuaW52YWxpZA0KTmV3c2dyb3VwczogZm4ubGV0dGVycw0KU3ViamVjdDog ; YSBQYXRoIHRoYXQgbmFtZXMgZm4NCkRhdGU6IFNhdCwgMjYgU2VwIDIwMjYgMTA6MDM6NDEgLTAw ; MDANCk1lc3NhZ2UtSUQ6IDxpbm4tbGFiLWZuLWxvb3AtYzc2NjVlNy0yMDI2MDkyNlQxMDAzNDFa...`
63. **IHAVE <inn-lab-fn-loop-c7665e7-20260926T100341Z@example.invalid> (Path names fnA.hbox.test) to fn** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py offer --port 11490 --msgid '<inn-lab-fn-loop-c7665e7-20260926T100341Z@example.invalid>' --file $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-loop.article --read`
64. **SIGTERM the fn owner** -- `kill -TERM 1280135 2>/dev/null || true ; for i in $(seq 1 60); do kill -0 1280135 2>/dev/null || break; sleep 1; done ; if kill -0 1280135 2>/dev/null; then kill -9 1280135; echo "OWNER-KILLED-AFTER-60S"; else echo OWNER-GONE; fi`
...
70. **reread <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> from fn after the restart** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py fetch --port 11490 --msgid '<inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid>'`
71. **reread <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> from fn after the restart** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py fetch --port 11490 --msgid '<inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>'`
72. **kill -9 innd** -- `kill -9 1278343 2>/dev/null || true ; for i in $(seq 1 20); do kill -0 1278343 2>/dev/null || break; sleep 1; done ; kill -0 1278343 2>/dev/null && echo INND-ALIVE || echo INND-GONE ; rm -f /tank/fn/inn/2.7.4/run/innd.pid /tank/fn/inn/2.7.4/run/control.ctl`
...
74. **after innd's restart, IHAVE <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py offer --port 11419 --msgid '<inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>' --file $HOME/fn-inn-lab/dev-c7665e7/gate-run/fed.article`
75. **after innd's restart, IHAVE <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid>** -- `cd $HOME/fn-inn-lab/dev-c7665e7 || exit 9 ; python3 $HOME/fn-inn-lab/dev-c7665e7/gate-run/inn.py offer --port 11419 --msgid '<inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid>' --file $HOME/fn-inn-lab/dev-c7665e7/gate-run/fn-post.article`
76. **stop the fn owner** -- `kill -TERM 1284073 2>/dev/null || true ; for i in $(seq 1 60); do kill -0 1284073 2>/dev/null || break; sleep 1; done ; if kill -0 1284073 2>/dev/null; then kill -9 1284073; echo "OWNER-KILLED-AFTER-60S"; else echo OWNER-GONE; fi`
77. **stop the relay** -- `kill 1279826 2>/dev/null || true; echo stopped`
78. **stop nnrpd** -- `kill 1279720 2>/dev/null || true; echo stopped`
79. **ctlinnd shutdown** -- `/tank/fn/inn/2.7.4/bin/ctlinnd -t 5 shutdown 'inn lab done' 2>&1 || true`
80. **innd and innfeed are gone** -- `for i in $(seq 1 20); do ; kill -0 1284735 2>/dev/null || break; sleep 1 ; done ; kill -0 1284735 2>/dev/null && echo INND-ALIVE || echo INND-GONE ; pid=$(cat /tank/fn/inn/2.7.4/run/innfeed.pid 2>/dev/null || echo -1) ; kill -0 $pid 2>/dev/null && echo INNFEED-ALIVE || echo INNFEED-GONE`
...
```
S: 200 inn.hbox.test InterNetNews server INN 2.7.4 ready (transit mode)
C: IHAVE <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid>
S: 335 Send it
...
C:   Date: Sat, 26 Sep 2026 10:03:41 -0000
C:   Message-ID: <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid>
C:   
C:   From the fn INN interop lab.
C: .
S: 235 Article transferred OK
C: IHAVE <inn-lab-fn-operator-c7665e7-20260926T100341Z@example.invalid>
S: 335 Send it
C:   Path: fnA.hbox.test!not-for-mail
C:   Injection-Info: fnA.hbox.test
C:   From: lab@example.invalid
...
C:   Date: Sat, 26 Sep 2026 10:03:41 -0000
C:   Message-ID: <inn-lab-fn-operator-c7665e7-20260926T100341Z@example.invalid>
C:   
C:   From the fn INN interop lab.
C: .
S: 235 Article transferred OK
C: IHAVE <inn-lab-fn-path-c7665e7-20260926T100341Z@example.invalid>
S: 335 Send it
C:   Injection-Info: fnA.hbox.test
C:   Path: fnA.hbox.test!not-for-mail
C:   From: lab@example.invalid
...
C:   Date: Sat, 26 Sep 2026 10:03:41 -0000
C:   Message-ID: <inn-lab-fn-path-c7665e7-20260926T100341Z@example.invalid>
C:   
C:   From the fn INN interop lab.
C: .
S: 235 Article transferred OK
...
C: CHECK <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>
S: 238 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>
C: TAKETHIS <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>
C:   Path: inn.hbox.test!lab.example.invalid!not-for-mail
C:   From: lab@example.invalid
C:   Newsgroups: fn.letters
C:   Subject: handed to INN, fed on to fn
C:   Date: Sat, 26 Sep 2026 10:03:41 -0000
C:   Message-ID: <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>
C:   Xref: inn.hbox.test fn.letters:82
C:   
C:   From the fn INN interop lab.
C: .
S: 239 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>
```
...
--- 40 POST <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> to the fn owner (rc=0)
{"greeting": "200 fn-nntp experimental server ready", "post": "340 send article to be posted", "result": "240 article received OK", "article": "220 0 <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "", "ok": true}
--- 41 relay log: fn's feed offers <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> to innd (rc=0)
IHAVE on 11418>11419: 335 Send it / 235 Article transferred OK
--- 42 read <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> back from INN's nnrpd (rc=0)
{"greeting": "200 inn.hbox.test InterNetNews NNRP server INN 2.7.4 ready (posting ok)", "group": "211 79 1 79 fn.letters", "article": "220 0 <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> article", "octets": "", "absent": "430 No such article", "ok": true}
--- 43 IHAVE <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> into innd again (rc=0)
...
--- 45 operator post <inn-lab-fn-operator-c7665e7-20260926T100341Z@example.invalid> (rc=0)
accepted operator post ACCEPTED
--- 46 relay log: fn's feed offers <inn-lab-fn-operator-c7665e7-20260926T100341Z@example.invalid> to innd (rc=0)
IHAVE on 11418>11419: 335 Send it / 235 Article transferred OK
--- 47 install fn-from.article (rc=0)
--- 48 POST <inn-lab-fn-from-c7665e7-20260926T100341Z@example.invalid> (From: yue) to the fn owner (rc=1)
...
--- 50 POST <inn-lab-fn-path-c7665e7-20260926T100341Z@example.invalid> (Path: not-for-mail) to the fn owner (rc=0)
{"greeting": "200 fn-nntp experimental server ready", "post": "340 send article to be posted", "result": "240 article received OK", "article": "220 0 <inn-lab-fn-path-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "", "ok": true}
--- 51 install fed.article (rc=0)
--- 52 install inn-loop.article (rc=0)
--- 53 IHAVE <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> into innd (rc=0)
{"greeting": "200 inn.hbox.test InterNetNews server INN 2.7.4 ready (transit mode)", "mode_stream": "203 Streaming permitted", "offer": "335 Send it", "transfer": "235 Article transferred OK", "duplicate": "435 Duplicate", "duplicate_transfer": "", "loop_offer": "335 Send it", "loop_result": "437 Unwanted site inn.hbox.test in path", "check_unknown": "238 <inn-lab-absent-c7665e7-20260926T100341Z@example.invalid> Send it", "check_duplicate": "438 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> Duplicate", "ok": true}
--- 54 INN history for <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> (rc=0)
@050000000007000000000000005200000000@
--- 55 ctlinnd flush fn (rc=0)
Ok
--- 56 relay log: innfeed offers <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> to fn (rc=0)
CHECK+TAKETHIS on 11417>11490: 238 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> / 239 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid>
--- 57 innfeed log (rc=0)
2026-09-26T06:04:04.726956-04:00 hbox innfeed[1278349]: ME finishing at Sat Sep 26 06:04:04 2026
2026-09-26T06:04:04.727218-04:00 hbox innd: innfeed! exit 0 elapsed 2 pid 1278349
2026-09-26T06:04:06.567128-04:00 hbox innfeed[1278946]: fn:0 cxnsleep connect: Connection refused
2026-09-26T06:04:06.567191-04:00 hbox innfeed[1278946]: fn spooling no active connections
2026-09-26T06:04:11.592163-04:00 hbox innfeed[1278946]: fn:0 connected
2026-09-26T06:04:11.592235-04:00 hbox innfeed[1278946]: fn remote MODE STREAM
2026-09-26T06:04:11.592266-04:00 hbox innfeed[1278946]: fn checkpoint seconds 5 spooled 0 on_close 0 sleeping 0
2026-09-26T06:04:11.592298-04:00 hbox innfeed[1278946]: fn final seconds 5 spooled 0 on_close 0 sleeping 0
--- 58 read <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> back from the fn owner (rc=0)
{"greeting": "200 fn-nntp experimental server ready", "article": "220 0 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "", "ok": true}
--- 59 read <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> back from INN's nnrpd (rc=0)
{"greeting": "200 inn.hbox.test InterNetNews NNRP server INN 2.7.4 ready (posting ok)", "group": "211 82 1 82 fn.letters", "article": "220 0 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> article", "octets": "", "absent": "430 No such article", "ok": true}
--- 60 IHAVE <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> to fn again (rc=0)
{"greeting": "200 fn-nntp experimental server ready", "offer": "435 duplicate", "result": "", "after": "220 0 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "", "ok": true}
--- 61 IHAVE <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> to fn again (rc=0)
{"greeting": "200 fn-nntp experimental server ready", "offer": "435 duplicate", "result": "", "after": "220 0 <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "", "ok": true}
--- 62 install fn-loop.article (rc=0)
--- 63 IHAVE <inn-lab-fn-loop-c7665e7-20260926T100341Z@example.invalid> (Path names fnA.hbox.test) to fn (rc=0)
...
accepted peer connection=3 peer=inn time=2026-09-26T10:04:13Z
refused post path=served connection=3 reason=from-invalid time=2026-09-26T10:04:13Z
accepted peer connection=4 peer=inn time=2026-09-26T10:04:13Z
accepted post path=served connection=4 message-id=<inn-lab-fn-path-c7665e7-20260926T100341Z@example.invalid> agent=fnA.hbox.test time=2026-09-26T10:04:13Z
accepted feed peer=inn message-id=<inn-lab-fn-path-c7665e7-20260926T100341Z@example.invalid> code=235 time=2026-09-26T10:04:13Z
accepted transit connection=2 message-id=<inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> code=239 decision=want reason=none detail=none time=2026-09-26T10:04:14Z
accepted peer connection=5 peer=inn time=2026-09-26T10:04:15Z
accepted peer connection=6 peer=inn time=2026-09-26T10:04:15Z
accepted peer connection=7 peer=inn time=2026-09-26T10:04:16Z
accepted peer connection=8 peer=inn time=2026-09-26T10:04:16Z
refused transit connection=8 message-id=<inn-lab-fn-loop-c7665e7-20260926T100341Z@example.invalid> code=437 decision=refuse reason=loop detail=none time=2026-09-26T10:04:16Z
...
LISTENING 11490
OWNER-UP pid=1284073
--- 70 reread <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> from fn after the restart (rc=0)
{"greeting": "200 fn-nntp experimental server ready", "article": "220 0 <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "", "ok": true}
--- 71 reread <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> from fn after the restart (rc=0)
{"greeting": "200 fn-nntp experimental server ready", "article": "220 0 <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> article follows", "octets": "", "ok": true}
--- 72 kill -9 innd (rc=0)
INND-GONE
--- 73 restart innd after the kill (rc=0)
INND-UP pid=1284735
--- 74 after innd's restart, IHAVE <inn-lab-fed-c7665e7-20260926T100341Z@example.invalid> (rc=0)
{"greeting": "200 inn.hbox.test InterNetNews server INN 2.7.4 ready (transit mode)", "offer": "435 Duplicate", "result": "", "ok": true}
--- 75 after innd's restart, IHAVE <inn-lab-fn-post-c7665e7-20260926T100341Z@example.invalid> (rc=0)
{"greeting": "200 inn.hbox.test InterNetNews server INN 2.7.4 ready (transit mode)", "offer": "435 Duplicate", "result": "", "ok": true}
