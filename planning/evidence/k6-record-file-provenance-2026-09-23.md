...
The theorem requires `fn-bs-statep`, a valid and fresh staging name, and a
...
examples for an occupied staging name, malformed frame and a stale pending
...
`python3 tools/farm.py wait hbox run-20260923T193652Z-ab21 --wait-seconds 30`.
...
`planning/evidence/manifests/certify-20260923T193655Z-4174743.json`.
