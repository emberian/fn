#!/bin/sh
# post-d25-tests runner (the qual-4eca4148 runner, scratch dir changed): one module (or test id) at a time, each to its own log.
...
set -u
G=/tank/fn/gates/qual-4eca4148-20260924
I=$G/build/images/4eca4148
S=/tank/fn/scratch/post-d25
T=$S/tree
L=$S/logs
mkdir -p "$L"
cd "$T"
h() { awk -v f="$1" '$2==f {print $1}' "$I/image.sha256"; }
export PATH=/tank/fn/scratch/qual-4eca4148/bin:$PATH
...
export FN_NATIVE_IMAGE_SOURCE_SHA=4eca4148
...
export FN_TEST_OPENSSL=/tank/fn/scratch/qual-4eca4148/bin/test-openssl
export FN_NATIVE_IMAGES=$I
