...
| `run-20260920T213846Z-bd4f` | the shipped shape, after merging dev `e5e6218`, which carries `w6/peering-feed-4`'s fix for `books/peer-feed-invariants` | same | recorded in `planning/lanes/HANDOFF-w10-kernel-freedom.md` §5 |
