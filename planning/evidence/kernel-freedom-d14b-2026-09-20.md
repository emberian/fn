...
| `run-20260920T214551Z-90a4` | the final tree, `--affected-by books/store-files.lisp --affected-by books/byte-store-scan.lisp --closure` | the `:rule-classes nil` and byte-store-scan-comment commits | recorded on the board |
