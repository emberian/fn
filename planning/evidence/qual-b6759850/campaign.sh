#!/bin/sh
# qual-b6759850 campaign: the 10 compaction cuts and 25 cuts (one run), the
...
set -u
S=/tank/fn/scratch/qual-b6759850/campaign
GT=/tank/fn/gates/qual-b6759850-20260926
G=$GT/build/images/b675985074cf14b009204f6eb3e5409f4a025a80
...
mkdir -p $S
cd /tank/fn/scratch/qual-b6759850/ctree
...
/usr/bin/time -v python3 ../d25b_matrix.py $G/fn-host-developer /tank/fn/scratch/d25-dup/img/build/fn-host-developer $S/d25-work 11396 /tank/fn/scratch/qual-b6759850/bin/test-openssl > $S/d25-matrix.log 2>&1; echo "rc=$?" >> $S/d25-matrix.log; fi
