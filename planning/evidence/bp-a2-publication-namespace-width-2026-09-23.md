...
## Integrated current-Store qualification

Root merged the coherent packet `2009cedd` with current stamped Store and
FNWF dependencies, preserving the fragment-family roots. Twenty changed or
dependent roots required new evidence at these combined bytes; hbox run
`run-20260923T184236Z-0991` passed in 33.293 seconds at two jobs with
76 matched dependencies installed. The exact manifest is
[`certify-20260923T184247Z-4092876.json`](manifests/certify-20260923T184247Z-4092876.json).
This is integrated ACL2 qualification; the native receive/TCPCL completion
and contact service remain concurrent implementation work.
