#!/usr/bin/env python3
"""qual-4eca4148 manual web pass: a scratch node on the production image with
...
S = Path("/tank/fn/scratch/qual-4eca4148")
T = S / "tree"
I = Path("/tank/fn/gates/qual-4eca4148-20260924/build/images/4eca4148")
W = S / "web"
OUT = W / "pages"
OPENSSL = str(S / "bin" / "test-openssl")
USER, SECRET = "reader", "web-pass-4eca4148"
