#!/bin/sh
# qual-4eca4148 campaign: 25-cut operator campaign once, the ACL2 differential,
# the NNTP probe once, the production external-kill run with one seed.
set -u
S=/tank/fn/scratch/qual-4eca4148/campaign
GT=/tank/fn/gates/qual-4eca4148-20260924
G=$GT/build/images/4eca4148
...
mkdir -p $S
cd /tank/fn/scratch/qual-4eca4148/ctree
