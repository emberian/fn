#!/bin/sh
# usage: setup3.sh TREE LABEL -- certify proof_artifacts default roots in place (incremental, from the cache), then build (with the profiling twin)
set -u
T=$1; L=$2; S=/tank/fn/scratch/rep-records-2
