#!/bin/sh
# qual-dfa810fc fact 1a: a checkpoint at the scale profile's largest admitted
...
import os, sys, time
sys.path.insert(0, "/tank/fn/scratch/qual-dfa810fc/tree/tools"); sys.path.insert(0, "/tank/fn/scratch/qual-dfa810fc/tree")
