# qual-dfa810fc: common paths and the test environment (sourced by every runner).
REV=dfa810fceabedde937ba7e4bfa46b43fd599ac62
G=/tank/fn/gates/qual-dfa810fc-20260926
...
export FN_NATIVE_IMAGE_SOURCE_SHA=dfa810fc
...
# qual-dfa810fc additions: b6759850's frozen images (the previous candidate, before :conflict) and the deployed bbf52159
