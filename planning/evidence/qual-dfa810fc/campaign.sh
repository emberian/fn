#!/bin/sh
# qual-dfa810fc campaign: the 10 compaction cuts and 25 cuts (one run), the
...
set -u
S=/tank/fn/scratch/qual-dfa810fc/campaign
GT=/tank/fn/gates/qual-dfa810fc-20260926
G=$GT/build/images/dfa810fceabedde937ba7e4bfa46b43fd599ac62
...
mkdir -p $S
cd /tank/fn/scratch/qual-dfa810fc/ctree
...
/usr/bin/time -v python3 ../d25b_matrix.py $G/fn-host-developer /tank/fn/scratch/d25-dup/img/build/fn-host-developer $S/d25-work 11396 /tank/fn/scratch/qual-dfa810fc/bin/test-openssl > $S/d25-matrix.log 2>&1; echo "rc=$?" >> $S/d25-matrix.log; fi
