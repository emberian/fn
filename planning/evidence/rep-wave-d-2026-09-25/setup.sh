#!/bin/sh
# usage: setup.sh TREE LABEL -- certify the default profile roots in place (incremental, from the cache), then build both images
set -u
T=$1; L=$2; S=/tank/fn/scratch/rep-wave-d
