#!/bin/sh
# qual-69046a76 fact 1a: a checkpoint at the scale profile's largest admitted
...
import os, sys, time
sys.path.insert(0, "/tank/fn/scratch/qual-69046a76/tree/tools"); sys.path.insert(0, "/tank/fn/scratch/qual-69046a76/tree")
