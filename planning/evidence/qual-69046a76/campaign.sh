#!/bin/sh
# qual-69046a76 campaign: the 10 compaction cuts and 25 cuts (one run), the
...
set -u
S=/tank/fn/scratch/qual-69046a76/campaign
GT=/tank/fn/gates/qual-69046a76-20260926
G=$GT/build/images/69046a76798b8be6169eeed5a66cc46fbe399e51
...
mkdir -p $S
cd /tank/fn/scratch/qual-69046a76/ctree
...
/usr/bin/time -v python3 ../d25b_matrix.py $G/fn-host-developer /tank/fn/scratch/d25-dup/img/build/fn-host-developer $S/d25-work 11396 /tank/fn/scratch/qual-69046a76/bin/test-openssl > $S/d25-matrix.log 2>&1; echo "rc=$?" >> $S/d25-matrix.log; fi
