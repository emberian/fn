#!/usr/bin/env python3
"""qual-69046a76, section 15 "Long-lived mixed workload": one measured hour on
...
def main():
    ...
    # qual-69046a76 harness repair: fn_consumer now requires its own keyring (the authors it trusts);
