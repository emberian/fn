#!/usr/bin/env python3
"""qual-69046a76 web pass, node side (hbox): a scratch node on the PRODUCTION
...
S = Path("/tank/fn/scratch/qual-69046a76")
T = S / "tree"
...
W = S / "webnode"
EMBER_PW, GUEST_PW = "web-ember-69046a76", "web-guest-69046a76"
E = bytes([0xEE]) * 32
