# qual-69046a76: common paths and the test environment (sourced by every runner).
REV=69046a76798b8be6169eeed5a66cc46fbe399e51
G=/tank/fn/gates/qual-69046a76-20260926
...
export FN_NATIVE_IMAGE_SOURCE_SHA=69046a76
...
# qual-69046a76 additions: b6759850's frozen images (the previous candidate, before :conflict) and the deployed bbf52159
B67I=/tank/fn/gates/qual-b6759850-20260926/build/images/b675985074cf14b009204f6eb3e5409f4a025a80
export FN_OLD_IMAGE=$OLDI/fn-host
export FN_NATIVE_TEST_ROOT=$T
