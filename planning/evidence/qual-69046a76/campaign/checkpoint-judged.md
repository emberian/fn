...
| `pack-chain-link` | developer | True | 0 | 0 | True | 0,0,0 | 1 already-compact | True | 0 | 2 -> 3 | PASS |
| `pack-chain-link` | operator | True | 0 | 0 | True | 0 | 1 already-compact | True | 0 | 2 -> 3 | PASS |
| `pack-reclaim-unlink` | developer | True | 1 | 0 | True | 0,0 | 1 already-compact | True | 0 | 2 -> 3 | PASS |
| `pack-reclaim-unlink` | operator | True | 0 | 0 | True | 1 | 1 already-compact | True | 0 | 2 -> 3 | PASS |
| `pack-reclaim-directory` | developer | True | 1 | 0 | True | 0,0 | 1 already-compact | True | 0 | 2 -> 3 | PASS |
| `pack-reclaim-directory` | operator | True | 0 | 0 | True | 1 | 1 already-compact | True | 0 | 2 -> 3 | PASS |
| `pack-retire-unlink` | developer | False | None | 0 | True | 0,0,0 | 1 already-compact | True | 0 | 2 -> 3 | FAIL |
| `pack-retire-unlink` | operator | False | None | 0 | True | 1 | 1 already-compact | True | 0 | 2 -> 3 | FAIL |
| `pack-retire-directory` | developer | False | None | 0 | True | 0,0,0 | 1 already-compact | True | 0 | 2 -> 3 | FAIL |
| `pack-retire-directory` | operator | False | None | 0 | True | 1 | 1 already-compact | True | 0 | 2 -> 3 | FAIL |

checkpoint observations: 18 of 22 pass; cuts 11
