#!/bin/sh
# qual-18c91321 native runner: one module (or test id) at a time, each to its own log.
...
set -u
G=/tank/fn/gates/qual-18c91321-20260924
I=$G/build/images/18c91321
S=/tank/fn/scratch/qual-18c91321
T=$S/tree
L=$S/logs
mkdir -p "$L"
cd "$T"
...
export FN_NATIVE_IMAGE_SOURCE_SHA=18c91321
