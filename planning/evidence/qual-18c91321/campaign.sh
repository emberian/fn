#!/bin/sh
# qual-18c91321 campaign: 25-cut operator campaign once, the ACL2 differential,
# the NNTP probe once, the production external-kill run with one seed.
set -u
S=/tank/fn/scratch/qual-18c91321/campaign
GT=/tank/fn/gates/qual-18c91321-20260924
G=$GT/build/images/18c91321
...
mkdir -p $S
cd /tank/fn/scratch/qual-18c91321/ctree
