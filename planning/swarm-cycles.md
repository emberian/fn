...
| `store-prepare-correspondence-sol` / Sol | Bounded native AUTHINFO source review. Actual configured-owner fast prepare, outer equality and scoped native runtime evidence are integrated. |
