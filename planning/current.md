...
- Keystone: `fn-sbud-prepare-refuses-at-budget` (books/owner-store-budget.lisp:37; PRF-004 (uncertified-at-current-digest)); no archived manifest certifies the current closure; `certify-20260924T161235Z-2188032` passed this source of `books/owner-store-budget.lisp`, and since then `books/acceptance-alloc.lisp`, `books/acceptance.lisp`, `books/accounts.lisp` and 75 more changed.
...
- Keystone: `fn-cverb-pack-fits-the-disk` (books/store-compact-verb.lisp:281; PRF-073 (uncertified-at-current-digest), PRF-129 (uncertified-at-current-digest)); no archived manifest certifies the current closure; `certify-20260926T065950Z-667448` passed this source of `books/store-compact-verb.lisp`, and since then `books/acceptance.lisp`, `books/byte-store-frame.lisp`, `books/checkpoint-pack-chain.lisp` and 10 more changed.
