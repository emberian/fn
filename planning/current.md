...
| --- | --- | --- | --- | --- | --- |
| [P1](#p1) protected channel | `fn-served-dispatch-of-a-gated-command-is-480-and-changes-nothing` | yes | yes: `certify-20260926T153813Z-3523837` | no: source changed since b6759850 | no: dev source not on the node |
| [P2](#p2) 240 after a consumed completion | `fn-own-240-follows-consumed-completion` | yes | no: closure moved | no: source changed since b6759850 | no: dev source not on the node |
| [P3](#p3) reading resumes | `fn-own-pinned-view-survives-other-post` | yes | no: closure moved | no: source changed since b6759850 | no: dev source not on the node |
...
| [P5](#p5) a connection-local fault costs one connection | `fn-ocfg-fault-keeps-every-other-connection` | yes | no: closure moved | no: source changed since b6759850 | no: dev source not on the node |
| [P6](#p6) live reconfiguration | `fn-ocl-no-reader-observes-a-half-change` | yes | no: closure moved | no: source changed since b6759850 | no: dev source not on the node |
| [P7](#p7) two nodes exchange both ways | `fn-own-submission-never-targets-a-loop` | yes | no: closure moved | no: source changed since b6759850 | no: dev source not on the node |
| [P8](#p8) signature verdict visible | `fn-own-read-hdr-fn-verified-is-the-pinned-verdict` | yes | yes: `certify-20260926T153813Z-3523837` | no: source changed since b6759850 | no: dev source not on the node |
...
| [P10](#p10) every cut is a model crash point | `fn-bs-recover-program-keeps-relation-at-every-cut` | yes | no: closure moved | no: source changed since b6759850 | no: dev source not on the node |
| [P11](#p11) bundles across an outage | `fn-bpnp-step-session-offer-is-the-scan-choice` | yes | no: closure moved | no: source changed since b6759850 | no: profile not deployed |
| [M4](#m4) disconnected exchange | `fn-bpaj-carried-request-is-judged-as-the-authors-direct-request` | yes | no: closure moved | no: source changed since b6759850 | no: profile not deployed |
...
| [T17](#t17) the Message-ID index on the served path | `fn-nntp-archive-command-pinned-msgid-arms-are-the-scan` | yes | yes: `certify-20260926T153813Z-3523837` | no: source changed since b6759850 | no: dev source not on the node |
...
- Keystone: `fn-served-dispatch-of-a-gated-command-is-480-and-changes-nothing` (books/nntp-auth-invariants.lisp:522; PRF-031 (uncertified-at-current-digest)); certified at the current source and closure by `certify-20260926T153813Z-3523837` (earliest archived).
...
- Keystone: `fn-own-240-follows-consumed-completion` (books/owner-served-invariants.lisp:135; PRF-015 (uncertified-at-current-digest)); no archived manifest certifies the current closure; `certify-20260924T161521Z-1600877` passed this source of `books/owner-served-invariants.lisp`, and since then `books/acceptance-alloc.lisp`, `books/acceptance.lisp`, `books/accounts.lisp` and 80 more changed.
...
- Keystone: `fn-own-pinned-view-survives-other-post` (books/owner-served-invariants.lisp:279; PRF-002 (uncertified-at-current-digest)); no archived manifest certifies the current closure; `certify-20260924T161521Z-1600877` passed this source of `books/owner-served-invariants.lisp`, and since then `books/acceptance-alloc.lisp`, `books/acceptance.lisp`, `books/accounts.lisp` and 80 more changed.
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2313, equated by `fn-scar-ocfg-read-tls-prefix-is-reference-under-ocl-relation` (books/owner-served-carried.lisp:219).
- Keystone: `fn-own-read-hdr-fn-verified-is-the-pinned-verdict` (books/owner-verdict-read.lisp:427; PRF-026 (uncertified-at-current-digest)); certified at the current source and closure by `certify-20260926T153813Z-3523837` (earliest archived).
...
- Keystone: `fn-sbud-prepare-refuses-at-budget` (books/owner-store-budget.lisp:37; PRF-004 (uncertified-at-current-digest)); no archived manifest certifies the current closure; `certify-20260924T161235Z-2188032` passed this source of `books/owner-store-budget.lisp`, and since then `books/acceptance-alloc.lisp`, `books/acceptance.lisp`, `books/accounts.lisp` and 77 more changed.
...
- Keystone: `fn-bs-recover-program-keeps-relation-at-every-cut` (books/byte-store-k0-recovery.lisp:469; PRF-041 (uncertified-at-current-digest)); no archived manifest certifies the current closure; `certify-20260924T184121Z-3505113` passed this source of `books/byte-store-k0-recovery.lisp`, and since then `books/acceptance-alloc.lisp`, `books/acceptance.lisp`, `books/accounts.lisp` and 81 more changed.
...
- Keystone: `fn-bpaj-carried-request-is-judged-as-the-authors-direct-request` (books/bp-transit-join.lisp:155; PRF-075 (uncertified-at-current-digest)); no archived manifest certifies the current closure; `certify-20260924T231054Z-2148356` passed this source of `books/bp-transit-join.lisp`, and since then `books/acceptance-alloc.lisp`, `books/acceptance.lisp`, `books/accounts.lisp` and 74 more changed.
...
- Keystone: `fn-nntp-archive-command-pinned-msgid-arms-are-the-scan` (books/nntp-pinned-msgid.lisp:32; PRF-067 (uncertified-at-current-digest)); certified at the current source and closure by `certify-20260926T153813Z-3523837` (earliest archived).
