...
| --- | --- | --- | --- | --- | --- |
| [P1](#p1) protected channel | `fn-served-dispatch-of-a-gated-command-is-480-and-changes-nothing` | yes | yes: `certify-20260925T195406Z-616568` | no: source changed since c3420013 | yes: bbf52159 |
| [P2](#p2) 240 after a consumed completion | `fn-own-240-follows-consumed-completion` | yes | yes: `certify-20260925T195354Z-615305` | no: source changed since c3420013 | yes: bbf52159 |
| [P3](#p3) reading resumes | `fn-own-pinned-view-survives-other-post` | yes | yes: `certify-20260925T195354Z-615305` | no: source changed since c3420013 | yes: bbf52159 |
| [P4](#p4) one owner decides duplicate versus conflict | `fn-pb-same-article-is-answered-already-stored` | yes | yes: `certify-20260925T195406Z-616568` | lab only: `9cb82454` | yes: bbf52159 |
| [P5](#p5) a connection-local fault costs one connection | `fn-ocfg-fault-keeps-every-other-connection` | yes | yes: `certify-20260925T195354Z-615305` | no: source changed since c3420013 | yes: bbf52159 |
| [P6](#p6) live reconfiguration | `fn-ocl-no-reader-observes-a-half-change` | yes | yes: `certify-20260925T195406Z-616568` | no: source changed since c3420013 | yes: bbf52159 |
| [P7](#p7) two nodes exchange both ways | `fn-own-submission-never-targets-a-loop` | yes | yes: `certify-20260925T195354Z-615305` | no: source changed since c3420013 | yes: bbf52159 |
| [P8](#p8) signature verdict visible | `fn-own-read-hdr-fn-verified-is-the-pinned-verdict` | yes | yes: `certify-20260925T195406Z-616568` | no: source changed since c3420013 | yes: bbf52159 |
| [P9](#p9) keep until release, refuse the unaffordable | `fn-sbud-prepare-refuses-at-budget` | yes | yes: `certify-20260925T195354Z-615305` | no: source changed since c3420013 | yes: bbf52159 |
| [P10](#p10) every cut is a model crash point | `fn-bs-recover-program-keeps-relation-at-every-cut` | yes | yes: `certify-20260925T195406Z-616568` | no: source changed since c3420013 | yes: bbf52159 |
...
| [M6](#m6) the human client | `fn-served-step-list-counts-is-the-archive-counts` | yes | yes: `certify-20260925T195406Z-616568` | lab only: `lane/m6-list-counts` | yes: bbf52159 |
| [T17](#t17) the Message-ID index on the served path | `fn-nntp-archive-command-pinned-msgid-arms-are-the-scan` | yes | yes: `certify-20260925T211549Z-3867068` | no: source changed since c3420013 | yes: bbf52159 |
