...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1742, equated by `fn-scar-auth-step-pinned-is-auth-step-pinned` (books/served-carried.lisp:177).
...
- Host-called subject: `fn-ccar-own-finish` at host/owner-host.lisp:819, equated by `fn-ccar-own-finish-is-own-finish` (books/owner-commit-carried.lisp:582).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1742, equated by `fn-scar-ocfg-read-tls-prefix-is-reference-under-ocl-relation` (books/owner-served-carried.lisp:219).
...
- Host-called subject: `fn-pb-existing-action` at host/owner-host.lisp:506, equated by `fn-pb-existing-action-refines-the-byte-identity-decision` (books/poster-bytes-invariants.lisp:412).
...
- Host-called subject: `fn-ocfg-fault` at host/owner-host.lisp:1775.
...
- Host-called subject: `fn-icar-submission-intent` at host/owner-host.lisp:1263, equated by `fn-own-submission-targets-are-feed-targets` (books/owner-feed-subject.lisp:35).
...
- Host-called subject: `fn-ock-recover-extended` at host/owner-host.lisp:175, equated by `fn-bs-host-reopened-kernel-is-the-recovered-kernel` (books/byte-store-k0-recovery.lisp:544).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1742, equated by `fn-own-read-is-served-step-on-pinned-prefix` (books/owner-invariants.lisp:1493).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1742, equated by `fn-ocfg-read-tls-prefix-is-full-read` (books/owner-tls-prefix.lisp:91).
