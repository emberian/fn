...
| [P2](#p2) 240 after a consumed completion | `fn-own-240-follows-consumed-completion` | yes | cache only: `certify-20260925T103652Z-3170879` | no: source changed since c3420013 | no: dev source not on the node |
| [P3](#p3) reading resumes | `fn-own-pinned-view-survives-other-post` | yes | cache only: `certify-20260925T103652Z-3170879` | no: source changed since c3420013 | no: dev source not on the node |
...
| [P5](#p5) a connection-local fault costs one connection | `fn-ocfg-fault-keeps-every-other-connection` | yes | cache only: `certify-20260925T103652Z-3170879` | no: source changed since c3420013 | no: dev source not on the node |
| [P6](#p6) live reconfiguration | `fn-ocl-no-reader-observes-a-half-change` | yes | yes: `certify-20260925T103652Z-3170879` | no: source changed since c3420013 | no: dev source not on the node |
...
| [P9](#p9) keep until release, refuse the unaffordable | `fn-sbud-prepare-refuses-at-budget` | yes | cache only: `certify-20260925T103652Z-3170879` | no: source changed since c3420013 | no: dev source not on the node |
...
| [M4](#m4) disconnected exchange | `fn-bpaj-carried-request-is-judged-as-the-authors-direct-request` | yes | yes: `certify-20260925T103652Z-3170879` | no: source changed since c3420013 | no: profile not deployed |
| [M5](#m5) maintenance: operator compaction | `fn-cverb-pack-fits-the-profile-budget` | yes | yes: `certify-20260925T103652Z-3170879` | lab only: `5181e0ea` | no: dev source not on the node |
...
- Keystone: `fn-own-240-follows-consumed-completion` (books/owner-served-invariants.lisp:135; PRF-015 (in-progress)); no archived manifest records it passed at the current source and closure; `certify-20260925T103652Z-3170879` installed a cached pair for them, made by a run not archived.
...
- Keystone: `fn-own-pinned-view-survives-other-post` (books/owner-served-invariants.lisp:279; PRF-002 (in-progress)); no archived manifest records it passed at the current source and closure; `certify-20260925T103652Z-3170879` installed a cached pair for them, made by a run not archived.
...
- Keystone: `fn-ocfg-fault-keeps-every-other-connection` (books/owner-served-invariants.lisp:327; PRF-040 (in-progress)); no archived manifest records it passed at the current source and closure; `certify-20260925T103652Z-3170879` installed a cached pair for them, made by a run not archived.
...
- Keystone: `fn-ocl-no-reader-observes-a-half-change` (books/config-owner-publish.lisp:180; PRF-028 (in-progress)); certified at the current source and closure by `certify-20260925T103652Z-3170879` (earliest archived).
- Tested: image `c3420013` ([qual-c3420013-2026-09-25](evidence/qual-c3420013-2026-09-25.md), closure `certify-20260925T001652Z-2229194`), profile native-operator matrix and native modules; changed since it: `host/owner-host.lisp`.
- Deployed: no: node image `c3420013`; changed since it: `host/owner-host.lisp`.
...
- Keystone: `fn-sbud-prepare-refuses-at-budget` (books/owner-store-budget.lisp:37; PRF-004 (in-progress)); no archived manifest records it passed at the current source and closure; `certify-20260925T103652Z-3170879` installed a cached pair for them, made by a run not archived.
...
- Keystone: `fn-bpaj-carried-request-is-judged-as-the-authors-direct-request` (books/bp-transit-join.lisp:155; PRF-075 (in-progress)); certified at the current source and closure by `certify-20260925T103652Z-3170879` (earliest archived).
...
- Keystone: `fn-cverb-pack-fits-the-profile-budget` (books/store-compact-verb.lisp:186; PRF-073 (in-progress)); certified at the current source and closure by `certify-20260925T103652Z-3170879` (earliest archived).
