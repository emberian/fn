...
| [P9](#p9) keep until release, refuse the unaffordable | `fn-sbud-prepare-refuses-at-budget` | yes | yes: `certify-20260926T152501Z-3400513` | no: source changed since b6759850 | no: dev source not on the node |
...
| [M5](#m5) maintenance: operator compaction | `fn-cverb-pack-fits-the-disk` | yes | yes: `certify-20260926T152501Z-3400513` | lab only: `5181e0ea` | no: dev source not on the node |
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2299, equated by `fn-scar-auth-step-pinned-is-auth-step-pinned` (books/served-carried.lisp:176).
...
- Host-called subject: `fn-ccar-own-finish` at host/owner-host.lisp:1003, equated by `fn-ccar-own-finish-is-own-finish` (books/owner-commit-carried.lisp:583).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2299, equated by `fn-scar-ocfg-read-tls-prefix-is-reference-under-ocl-relation` (books/owner-served-carried.lisp:219).
...
- Host-called subject: `fn-ocfg-fault` at host/owner-host.lisp:2343.
...
- Host-called subject: `fn-icar-submission-intent` at host/owner-host.lisp:1471, equated by `fn-own-submission-targets-are-feed-targets` (books/owner-feed-subject.lisp:35).
...
- Keystone: `fn-sbud-prepare-refuses-at-budget` (books/owner-store-budget.lisp:37; PRF-004 (uncertified-at-current-digest)); certified at the current source and closure by `certify-20260926T152501Z-3400513` (earliest archived).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2299, equated by `fn-own-read-is-served-step-on-pinned-prefix` (books/owner-invariants.lisp:1717).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2299, equated by `fn-ocfg-read-tls-prefix-is-full-read` (books/owner-tls-prefix.lisp:91).
