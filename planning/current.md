...
| --- | --- | --- | --- | --- | --- |
| [P1](#p1) protected channel | `fn-served-dispatch-of-a-gated-command-is-480-and-changes-nothing` | yes | yes: `certify-20260926T150134Z-3185056` | no: source changed since b6759850 | no: dev source not on the node |
| [P2](#p2) 240 after a consumed completion | `fn-own-240-follows-consumed-completion` | yes | yes: `certify-20260926T150134Z-3185056` | no: source changed since b6759850 | no: dev source not on the node |
| [P3](#p3) reading resumes | `fn-own-pinned-view-survives-other-post` | yes | yes: `certify-20260926T150134Z-3185056` | no: source changed since b6759850 | no: dev source not on the node |
...
| [P5](#p5) a connection-local fault costs one connection | `fn-ocfg-fault-keeps-every-other-connection` | yes | yes: `certify-20260926T150134Z-3185056` | no: source changed since b6759850 | no: dev source not on the node |
| [P6](#p6) live reconfiguration | `fn-ocl-no-reader-observes-a-half-change` | yes | yes: `certify-20260926T150134Z-3185056` | no: source changed since b6759850 | no: dev source not on the node |
| [P7](#p7) two nodes exchange both ways | `fn-own-submission-never-targets-a-loop` | yes | yes: `certify-20260926T150134Z-3185056` | no: source changed since b6759850 | no: dev source not on the node |
| [P8](#p8) signature verdict visible | `fn-own-read-hdr-fn-verified-is-the-pinned-verdict` | yes | yes: `certify-20260926T150134Z-3185056` | no: source changed since b6759850 | no: dev source not on the node |
| [P9](#p9) keep until release, refuse the unaffordable | `fn-sbud-prepare-refuses-at-budget` | yes | no: closure moved | no: source changed since b6759850 | no: dev source not on the node |
| [P10](#p10) every cut is a model crash point | `fn-bs-recover-program-keeps-relation-at-every-cut` | yes | yes: `certify-20260926T150134Z-3185056` | no: source changed since b6759850 | no: dev source not on the node |
| [P11](#p11) bundles across an outage | `fn-bpnp-step-session-offer-is-the-scan-choice` | yes | yes: `certify-20260926T150134Z-3185056` | no: source changed since b6759850 | no: profile not deployed |
| [M4](#m4) disconnected exchange | `fn-bpaj-carried-request-is-judged-as-the-authors-direct-request` | yes | yes: `certify-20260926T150134Z-3185056` | no: source changed since b6759850 | no: profile not deployed |
...
| [T17](#t17) the Message-ID index on the served path | `fn-nntp-archive-command-pinned-msgid-arms-are-the-scan` | yes | yes: `certify-20260926T140805Z-2669526` | no: source changed since b6759850 | no: dev source not on the node |
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2296, equated by `fn-scar-auth-step-pinned-is-auth-step-pinned` (books/served-carried.lisp:176).
...
- Host-called subject: `fn-ccar-own-finish` at host/owner-host.lisp:1000, equated by `fn-ccar-own-finish-is-own-finish` (books/owner-commit-carried.lisp:582).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2296, equated by `fn-scar-ocfg-read-tls-prefix-is-reference-under-ocl-relation` (books/owner-served-carried.lisp:219).
...
- Tested: image `b6759850` ([qual-b6759850-2026-09-26](evidence/qual-b6759850-2026-09-26.md), closure `certify-20260926T050746Z-356474`), profile native-operator matrix and native modules (qual-b6759850: every image-gated module on the four frozen images, 154 module runs; deployable, awaiting ember's go); changed since it: `host/owner-host.lisp`.
...
- Host-called subject: `fn-rcl-existing-action` at host/owner-host.lisp:664, equated by `fn-rcl-existing-action-is-pb-without-a-tombstone` (books/store-reclaim.lisp:573).
...
- Host-called subject: `fn-ocfg-fault` at host/owner-host.lisp:2340.
...
- Host-called subject: `fn-ocl-publish` at host/owner-host.lisp:617.
...
- Host-called subject: `fn-icar-submission-intent` at host/owner-host.lisp:1468, equated by `fn-own-submission-targets-are-feed-targets` (books/owner-feed-subject.lisp:35).
...
- Tested: image `b6759850` ([qual-b6759850-2026-09-26](evidence/qual-b6759850-2026-09-26.md), closure `certify-20260926T050746Z-356474`), profile two-node native-operator matrix with INN (qual-b6759850: every image-gated module on the four frozen images, 154 module runs; deployable, awaiting ember's go); changed since it: `books/owner-feed-subject.lisp`, `host/owner-host.lisp`.
...
- Host-called subject: `fn-pcar-sbud-prepare` at host/owner-host.lisp:702, equated by `fn-pcar-sbud-prepare-is-sbud-prepare` (books/owner-prepare-carried.lisp:223).
...
- Host-called subject: `fn-ock-recover-extended` at host/owner-host.lisp:239, equated by `fn-bs-host-reopened-kernel-is-the-recovered-kernel` (books/byte-store-k0-recovery.lisp:544).
...
- Tested: image `b6759850` ([qual-b6759850-2026-09-26](evidence/qual-b6759850-2026-09-26.md), closure `certify-20260926T050746Z-356474`), profile developer twin for the cuts, production refuses selectors (qual-b6759850: every image-gated module on the four frozen images, 154 module runs; deployable, awaiting ember's go); changed since it: `host/owner-host.lisp`.
- Deployed: no: node image `bbf52159`; changed since it: `host/owner-host.lisp`.
...
- Tested: image `b6759850` ([qual-b6759850-2026-09-26](evidence/qual-b6759850-2026-09-26.md), closure `certify-20260926T050746Z-356474`), profile dtn developer and production images, frozen (qual-b6759850: every image-gated module on the four frozen images, 154 module runs; deployable, awaiting ember's go); changed since it: `host/bp-native-app-host.lisp`.
- Deployed: no: the node runs default, this needs dtn.
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2296, equated by `fn-own-read-is-served-step-on-pinned-prefix` (books/owner-invariants.lisp:1717).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2296, equated by `fn-ocfg-read-tls-prefix-is-full-read` (books/owner-tls-prefix.lisp:91).
