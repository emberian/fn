...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2019, equated by `fn-scar-auth-step-pinned-is-auth-step-pinned` (books/served-carried.lisp:177).
...
- Host-called subject: `fn-ccar-own-finish` at host/owner-host.lisp:924, equated by `fn-ccar-own-finish-is-own-finish` (books/owner-commit-carried.lisp:582).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2019, equated by `fn-scar-ocfg-read-tls-prefix-is-reference-under-ocl-relation` (books/owner-served-carried.lisp:219).
...
- Host-called subject: `fn-rcl-existing-action` at host/owner-host.lisp:591, equated by `fn-rcl-existing-action-is-pb-without-a-tombstone` (books/store-reclaim.lisp:573).
...
- Host-called subject: `fn-ocfg-fault` at host/owner-host.lisp:2059.
...
- Host-called subject: `fn-ocl-publish` at host/owner-host.lisp:544.
- Keystone: `fn-ocl-no-reader-observes-a-half-change` (books/config-owner-publish.lisp:180; PRF-028 (certified)); certified at the current source and closure by `certify-20260926T064807Z-632722` (earliest archived).
...
- Host-called subject: `fn-icar-submission-intent` at host/owner-host.lisp:1392, equated by `fn-own-submission-targets-are-feed-targets` (books/owner-feed-subject.lisp:35).
...
- Host-called subject: `fn-pcar-sbud-prepare` at host/owner-host.lisp:629, equated by `fn-pcar-sbud-prepare-is-sbud-prepare` (books/owner-prepare-carried.lisp:223).
...
- Host-called subject: `fn-ock-recover-extended` at host/owner-host.lisp:225, equated by `fn-bs-host-reopened-kernel-is-the-recovered-kernel` (books/byte-store-k0-recovery.lisp:544).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2019, equated by `fn-own-read-is-served-step-on-pinned-prefix` (books/owner-invariants.lisp:1716).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:2019, equated by `fn-ocfg-read-tls-prefix-is-full-read` (books/owner-tls-prefix.lisp:91).
