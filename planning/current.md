...
| [M5](#m5) maintenance: operator compaction | `fn-cverb-pack-fits-the-disk` | yes | no: source uncertified | no: source changed since 69046a76 | no: dev source not on the node |
...
- Keystone: `fn-bs-recover-program-keeps-relation-at-every-cut` (books/byte-store-k0-recovery.lisp:469; PRF-041 (uncertified-at-current-digest)); no archived manifest certifies the current closure; `certify-20260924T184121Z-3505113` passed this source of `books/byte-store-k0-recovery.lisp`, and since then `books/acceptance-alloc.lisp`, `books/acceptance.lisp`, `books/accounts.lisp` and 82 more changed.
...
- Keystone: `fn-cverb-pack-fits-the-disk` (books/store-compact-verb.lisp:281; PRF-073 (uncertified-at-current-digest), PRF-129 (uncertified-at-current-digest)); no archived manifest records `books/store-compact-verb.lisp` passed at its current source.
...
- Keystone: `fn-served-step-list-counts-is-the-archive-counts` (books/owner-list-counts-read.lisp:167; PRF-074 (uncertified-at-current-digest)); no archived manifest certifies the current closure; `certify-20260926T182855Z-843486` passed this source of `books/owner-list-counts-read.lisp`, and since then `books/byte-store-frame.lisp`, `books/consumer-position.lisp`, `books/group-bucket-article.lisp` and 6 more changed.
