...
| [P2](#p2) 240 after a consumed completion | `fn-own-240-follows-consumed-completion` | yes | yes: `certify-20260925T195406Z-616568` | no: source changed since c3420013 | no: dev source not on the node |
| [P3](#p3) reading resumes | `fn-own-pinned-view-survives-other-post` | yes | yes: `certify-20260925T195406Z-616568` | no: source changed since c3420013 | no: dev source not on the node |
...
| [P5](#p5) a connection-local fault costs one connection | `fn-ocfg-fault-keeps-every-other-connection` | yes | yes: `certify-20260925T195406Z-616568` | no: source changed since c3420013 | no: dev source not on the node |
...
| [P7](#p7) two nodes exchange both ways | `fn-own-submission-never-targets-a-loop` | yes | yes: `certify-20260925T195406Z-616568` | no: source changed since c3420013 | no: dev source not on the node |
...
| [P9](#p9) keep until release, refuse the unaffordable | `fn-sbud-prepare-refuses-at-budget` | yes | yes: `certify-20260925T195406Z-616568` | no: source changed since c3420013 | no: dev source not on the node |
...
| [P11](#p11) bundles across an outage | `fn-bpnp-step-session-offer-is-the-scan-choice` | yes | yes: `certify-20260925T195406Z-616568` | no: source changed since c3420013 | no: profile not deployed |
...
| [M5](#m5) maintenance: operator compaction | `fn-cverb-pack-fits-the-profile-budget` | yes | yes: `certify-20260925T194254Z-3661260` | lab only: `5181e0ea` | no: dev source not on the node |
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1923, equated by `fn-scar-auth-step-pinned-is-auth-step-pinned` (books/served-carried.lisp:177).
...
- Host-called subject: `fn-ccar-own-finish` at host/owner-host.lisp:866, equated by `fn-ccar-own-finish-is-own-finish` (books/owner-commit-carried.lisp:582).
- Keystone: `fn-own-240-follows-consumed-completion` (books/owner-served-invariants.lisp:135; PRF-015 (in-progress)); certified at the current source and closure by `certify-20260925T195406Z-616568` (earliest archived).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1923, equated by `fn-scar-ocfg-read-tls-prefix-is-reference-under-ocl-relation` (books/owner-served-carried.lisp:219).
- Keystone: `fn-own-pinned-view-survives-other-post` (books/owner-served-invariants.lisp:279; PRF-002 (in-progress)); certified at the current source and closure by `certify-20260925T195406Z-616568` (earliest archived).
...
- Host-called subject: `fn-rcl-existing-action` at host/owner-host.lisp:553, equated by `fn-rcl-existing-action-is-pb-without-a-tombstone` (books/store-reclaim.lisp:573).
...
- Host-called subject: `fn-ocfg-fault` at host/owner-host.lisp:1963.
- Keystone: `fn-ocfg-fault-keeps-every-other-connection` (books/owner-served-invariants.lisp:327; PRF-040 (in-progress)); certified at the current source and closure by `certify-20260925T195406Z-616568` (earliest archived).
...
- Host-called subject: `fn-ocl-publish` at host/owner-host.lisp:506.
...
- Host-called subject: `fn-icar-submission-intent` at host/owner-host.lisp:1323, equated by `fn-own-submission-targets-are-feed-targets` (books/owner-feed-subject.lisp:35).
- Keystone: `fn-own-submission-never-targets-a-loop` (books/owner-feed-subject.lisp:63; PRF-029 (in-progress)); certified at the current source and closure by `certify-20260925T195406Z-616568` (earliest archived).
...
- Host-called subject: `fn-pcar-sbud-prepare` at host/owner-host.lisp:581, equated by `fn-pcar-sbud-prepare-is-sbud-prepare` (books/owner-prepare-carried.lisp:223).
- Keystone: `fn-sbud-prepare-refuses-at-budget` (books/owner-store-budget.lisp:37; PRF-004 (in-progress)); certified at the current source and closure by `certify-20260925T195406Z-616568` (earliest archived).
...
- Host-called subject: `fn-ock-recover-extended` at host/owner-host.lisp:210, equated by `fn-bs-host-reopened-kernel-is-the-recovered-kernel` (books/byte-store-k0-recovery.lisp:544).
...
- Keystone: `fn-bpnp-step-session-offer-is-the-scan-choice` (books/bp-node-forward-retry.lisp:153; PRF-046 (in-progress), PRF-103 (in-progress)); certified at the current source and closure by `certify-20260925T195406Z-616568` (earliest archived).
...
- Keystone: `fn-cverb-pack-fits-the-profile-budget` (books/store-compact-verb.lisp:186; PRF-073 (in-progress)); certified at the current source and closure by `certify-20260925T194254Z-3661260` (earliest archived).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1923, equated by `fn-own-read-is-served-step-on-pinned-prefix` (books/owner-invariants.lisp:1589).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1923, equated by `fn-ocfg-read-tls-prefix-is-full-read` (books/owner-tls-prefix.lisp:91).
