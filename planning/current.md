...
| --- | --- | --- | --- | --- | --- |
| [P1](#p1) protected channel | `fn-served-dispatch-of-a-gated-command-is-480-and-changes-nothing` | yes | no: closure moved | no: source changed since b6759850 | no: dev source not on the node |
...
| [P8](#p8) signature verdict visible | `fn-own-read-hdr-fn-verified-is-the-pinned-verdict` | yes | no: closure moved | no: source changed since b6759850 | no: dev source not on the node |
...
| [T17](#t17) the Message-ID index on the served path | `fn-nntp-archive-command-pinned-msgid-arms-are-the-scan` | yes | no: closure moved | no: source changed since b6759850 | no: dev source not on the node |
