...
| [P11](#p11) bundles across an outage | `fn-bpnp-step-session-offer-is-the-scan-choice` | yes | yes: `certify-20260926T004054Z-4151228` | no: source changed since c3420013 | no: profile not deployed |
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1972, equated by `fn-scar-auth-step-pinned-is-auth-step-pinned` (books/served-carried.lisp:177).
...
- Host-called subject: `fn-ccar-own-finish` at host/owner-host.lisp:886, equated by `fn-ccar-own-finish-is-own-finish` (books/owner-commit-carried.lisp:582).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1972, equated by `fn-scar-ocfg-read-tls-prefix-is-reference-under-ocl-relation` (books/owner-served-carried.lisp:219).
...
- Host-called subject: `fn-rcl-existing-action` at host/owner-host.lisp:565, equated by `fn-rcl-existing-action-is-pb-without-a-tombstone` (books/store-reclaim.lisp:573).
- Keystone: `fn-pb-same-article-is-answered-already-stored` (books/poster-bytes-invariants.lisp:451; in no registry row); certified at the current source and closure by `certify-20260925T233850Z-2619263` (earliest archived).
...
- Host-called subject: `fn-ocfg-fault` at host/owner-host.lisp:2012.
...
- Host-called subject: `fn-ocl-publish` at host/owner-host.lisp:518.
...
- Host-called subject: `fn-pcar-sbud-prepare` at host/owner-host.lisp:597, equated by `fn-pcar-sbud-prepare-is-sbud-prepare` (books/owner-prepare-carried.lisp:223).
...
- Host-called subject: `fn-ock-recover-extended` at host/owner-host.lisp:222, equated by `fn-bs-host-reopened-kernel-is-the-recovered-kernel` (books/byte-store-k0-recovery.lisp:544).
...
- Host-called subject: `fn-bpnj-step` at host/native/bp-service.lisp:195, equated by `fn-bpnj-step-delegates-every-other-event` (books/bp-node-job-offer.lisp:181).
- Keystone: `fn-bpnp-step-session-offer-is-the-scan-choice` (books/bp-node-forward-retry.lisp:153; PRF-046 (in-progress), PRF-103 (in-progress)); certified at the current source and closure by `certify-20260926T004054Z-4151228` (earliest archived).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1972, equated by `fn-own-read-is-served-step-on-pinned-prefix` (books/owner-invariants.lisp:1684).
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1972, equated by `fn-ocfg-read-tls-prefix-is-full-read` (books/owner-tls-prefix.lisp:91).
