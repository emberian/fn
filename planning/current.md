...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1711, equated by `fn-scar-ocfg-read-tls-prefix-is-reference-under-ocl-relation` (books/owner-served-carried.lisp:219).
...
- Host-called subject: `fn-pb-existing-action` at host/owner-host.lisp:505, equated by `fn-pb-existing-action-refines-the-byte-identity-decision` (books/poster-bytes-invariants.lisp:227).
- Keystone: `fn-pb-same-article-is-answered-already-stored` (books/poster-bytes-invariants.lisp:266; in no registry row); no archived manifest certifies the current closure; `certify-20260925T001158Z-2227754` passed this source of `books/poster-bytes-invariants.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 35 more changed.
...
- Host-called subject: `fn-ocfg-fault` at host/owner-host.lisp:1744.
...
- Host-called subject: `fn-ocl-publish` at host/owner-host.lisp:458.
...
- Host-called subject: `fn-icar-submission-intent` at host/owner-host.lisp:1262, equated by `fn-own-submission-targets-are-feed-targets` (books/owner-feed-subject.lisp:35).
...
- Host-called subject: `fn-pcar-sbud-prepare` at host/owner-host.lisp:533, equated by `fn-pcar-sbud-prepare-is-sbud-prepare` (books/owner-prepare-carried.lisp:223).
...
- Keystone: `fn-bpaj-carried-request-is-judged-as-the-authors-direct-request` (books/bp-transit-join.lisp:155; PRF-075 (in-progress)); no archived manifest certifies the current closure; `certify-20260924T231054Z-2148356` passed this source of `books/bp-transit-join.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 40 more changed.
...
- Keystone: `fn-cverb-pack-fits-the-profile-budget` (books/store-compact-verb.lisp:186; PRF-073 (in-progress)); no archived manifest certifies the current closure; `certify-20260925T044439Z-546808` passed this source of `books/store-compact-verb.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 25 more changed.
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1711, equated by `fn-ocfg-read-tls-prefix-is-full-read` (books/owner-tls-prefix.lisp:91).
