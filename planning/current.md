...
- Keystone: `fn-own-240-follows-consumed-completion` (books/owner-served-invariants.lisp:135; PRF-015 (in-progress)); no archived manifest certifies the current closure; `certify-20260924T161521Z-1600877` passed this source of `books/owner-served-invariants.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 48 more changed.
...
- Keystone: `fn-own-pinned-view-survives-other-post` (books/owner-served-invariants.lisp:279; PRF-002 (in-progress)); no archived manifest certifies the current closure; `certify-20260924T161521Z-1600877` passed this source of `books/owner-served-invariants.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 48 more changed.
...
- Keystone: `fn-pb-same-article-is-answered-already-stored` (books/poster-bytes-invariants.lisp:451; in no registry row); no archived manifest certifies the current closure; `certify-20260925T092155Z-3183327` passed this source of `books/poster-bytes-invariants.lisp`, and since then `books/config-invariants.lisp`, `books/config.lisp`, `books/control-authority.lisp` and 10 more changed.
...
- Keystone: `fn-ocfg-fault-keeps-every-other-connection` (books/owner-served-invariants.lisp:327; PRF-040 (in-progress)); no archived manifest certifies the current closure; `certify-20260924T161521Z-1600877` passed this source of `books/owner-served-invariants.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 48 more changed.
...
- Keystone: `fn-own-submission-never-targets-a-loop` (books/owner-feed-subject.lisp:63; PRF-029 (in-progress)); no archived manifest certifies the current closure; `certify-20260924T144913Z-1419146` passed this source of `books/owner-feed-subject.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 44 more changed.
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1807, equated by `fn-scar-ocfg-read-tls-prefix-is-reference-under-ocl-relation` (books/owner-served-carried.lisp:219).
- Keystone: `fn-own-read-hdr-fn-verified-is-the-pinned-verdict` (books/owner-verdict-read.lisp:416; PRF-026 (planned)); no archived manifest certifies the current closure; `certify-20260924T144845Z-1414150` passed this source of `books/owner-verdict-read.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 46 more changed.
...
- Keystone: `fn-sbud-prepare-refuses-at-budget` (books/owner-store-budget.lisp:37; PRF-004 (in-progress)); no archived manifest certifies the current closure; `certify-20260924T161235Z-2188032` passed this source of `books/owner-store-budget.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 51 more changed.
...
- Keystone: `fn-bs-recover-program-keeps-relation-at-every-cut` (books/byte-store-k0-recovery.lisp:469; PRF-041 (in-progress)); no archived manifest certifies the current closure; `certify-20260924T184121Z-3505113` passed this source of `books/byte-store-k0-recovery.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 57 more changed.
...
- Host-called subject: `fn-scar-ocfg-read-tls-prefix` at host/owner-host.lisp:1807, equated by `fn-own-read-is-served-step-on-pinned-prefix` (books/owner-invariants.lisp:1590).
- Keystone: `fn-served-step-list-counts-is-the-archive-counts` (books/owner-list-counts-read.lisp:165; PRF-074 (in-progress)); no archived manifest certifies the current closure; `certify-20260924T214755Z-939221` passed this source of `books/owner-list-counts-read.lisp`, and since then `books/acceptance-alloc.lisp`, `books/article-fields.lisp`, `books/article.lisp` and 41 more changed.
