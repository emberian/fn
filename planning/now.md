...
[docs/agents.md](../docs/agents.md). Live lanes: `w31-freeze-3` (T0: the last two reds,
...
store cluster), `t8/reconfig` (live reconfiguration), `t9c/feed-tls` (the
outbound protected feed). T7, T11 and the T12a design landed; the release
replay the production build needs landed (2788d4cb); root ran T14 and T15
(5f7d0c2d, 3fa17fa5). The current phase is 0. The dated narrative this file
