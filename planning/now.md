...
[docs/agents.md](../docs/agents.md). Live lanes: `w31-freeze-3` (T0, the
last three store reds), T7 landed, T11 landed (6a85e3f2), the T12a design landed (a388826f,
`specs/bp-node-machine.md`); root ran T14 and T15
