...
| --- | --- |
| Books read | 244 |
| Certification roots in the Makefile | 243 |
| Books inside the root closure | 243 |
| `defthm` and `defthmd` events | 4649 |
| `defun` events | 3398 |
| Functions with verified guards | 1329 |
| Functions declared `:verify-guards nil` and never verified | 156 |
| Functions left at the default with an explicit guard | 1440 |
| Functions left at the default with no guard | 473 |
| `assert-event` checks | 4607 |
| `must-fail` checks | 59 |
