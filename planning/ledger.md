...
| --- | --- |
| Books read | 906 |
| Certification roots in the Makefile | 889 |
| Books inside the root closure | 902 |
| `defthm` and `defthmd` events | 12528 |
| `defun` events | 8763 |
...
| Functions left at the default with no guard | 1312 |
| `assert-event` checks | 13128 |
