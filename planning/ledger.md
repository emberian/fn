...
| --- | --- |
| Books read | 730 |
| Certification roots in the Makefile | 719 |
| Books inside the root closure | 728 |
| `defthm` and `defthmd` events | 9737 |
| `defun` events | 6879 |
| Functions with verified guards | 2058 |
| Functions declared `:verify-guards nil` and never verified | 449 |
| Functions left at the default with an explicit guard | 3413 |
| Functions left at the default with no guard | 959 |
| `assert-event` checks | 10636 |
| `must-fail` checks | 840 |
...
| `books/bp-fnbs-family-replay.lisp` | root | 1 | 4 | 0/0/4/0 | 0 | 0 | 0 |
...
| `books/bp-ion-workflow.lisp` | root | 2 | 15 | 0/15/0/0 | 0 | 0 | 0 |
...
| `books/bp-node-progress.lisp` | root | 0 | 59 | 0/5/54/0 | 0 | 0 | 0 |
...
| `books/native-admin.lisp` | root | 19 | 48 | 1/0/47/0 | 0 | 0 | 0 |
...
| `books/native-operator.lisp` | root | 2 | 62 | 0/0/62/0 | 0 | 0 | 0 |
...
| `books/owner-signed-post.lisp` | root | 13 | 0 | 0/0/0/0 | 0 | 0 | 0 |
...
| `books/peer-authored-accept.lisp` | root | 3 | 5 | 0/0/5/0 | 0 | 0 | 0 |
...
| `tests/acl2/bp-node-counterexamples-tests.lisp` | root | 0 | 5 | 0/5/0/0 | 16 | 15 | 0 |
...
| `tests/acl2/native-admin-tests.lisp` | root | 0 | 3 | 0/0/0/3 | 120 | 8 | 0 |
...
| `tests/acl2/native-operator-tests.lisp` | root | 0 | 2 | 0/0/0/2 | 127 | 3 | 0 |
...
| `tests/acl2/owner-signed-post-tests.lisp` | root | 0 | 7 | 0/0/0/7 | 30 | 11 | 0 |
