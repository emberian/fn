...
| --- | --- |
| Books read | 248 |
| Certification roots in the Makefile | 247 |
| Books inside the root closure | 247 |
| `defthm` and `defthmd` events | 4755 |
| `defun` events | 3465 |
