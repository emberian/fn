...
| --- | --- |
| Books read | 488 |
| Certification roots in the Makefile | 483 |
| Books inside the root closure | 487 |
| `defthm` and `defthmd` events | 7510 |
| `defun` events | 5772 |
...
| `tests/acl2/bp-node-receive-boundary-tests.lisp` | root | 0 | 0 | 0/0/0/0 | 13 | 1 | 0 |
