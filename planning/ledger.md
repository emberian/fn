...
| `defthm` and `defthmd` events | 8390 |
| `defun` events | 6250 |
...
| `assert-event` checks | 9123 |
| `must-fail` checks | 478 |
...
| `books/byte-store-record-provenance.lisp` | root | 154 | 0 | 0/0/0/0 | 0 | 0 | 0 |
...
| `tests/acl2/byte-store-record-provenance-tests.lisp` | root | 1 | 32 | 0/1/0/31 | 34 | 41 | 0 |
