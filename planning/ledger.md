...
| `defthm` and `defthmd` events | 8401 |
| `defun` events | 6250 |
...
| `books/byte-store-record-provenance.lisp` | root | 165 | 0 | 0/0/0/0 | 0 | 0 | 0 |
...
| `tests/acl2/byte-store-record-provenance-tests.lisp` | root | 1 | 32 | 0/1/0/31 | 34 | 42 | 0 |
