...
| --- | --- |
| Books read | 684 |
| Certification roots in the Makefile | 673 |
| Books inside the root closure | 682 |
| `defthm` and `defthmd` events | 9272 |
| `defun` events | 6661 |
...
| Functions left at the default with no guard | 901 |
| `assert-event` checks | 10023 |
| `must-fail` checks | 687 |
