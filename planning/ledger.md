...
| `defthm` and `defthmd` events | 8046 |
| `defun` events | 6042 |
...
| `books/byte-store-record-provenance.lisp` | root | 82 | 0 | 0/0/0/0 | 0 | 0 | 0 |
...
| `tests/acl2/byte-store-record-provenance-tests.lisp` | root | 1 | 19 | 0/1/0/18 | 20 | 18 | 0 |
