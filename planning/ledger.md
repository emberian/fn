...
| `defthm` and `defthmd` events | 8383 |
| `defun` events | 6249 |
...
| `books/byte-store-record-provenance.lisp` | root | 147 | 0 | 0/0/0/0 | 0 | 0 | 0 |
...
| `tests/acl2/byte-store-record-provenance-tests.lisp` | root | 1 | 31 | 0/1/0/30 | 33 | 40 | 0 |
