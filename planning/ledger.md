...
| `defthm` and `defthmd` events | 2914 |
| `defun` events | 2077 |
| Functions with verified guards | 950 |
| Functions declared `:verify-guards nil` and never verified | 121 |
| Functions left at the default with an explicit guard | 573 |
| Functions left at the default with no guard | 433 |
| `assert-event` checks | 3083 |
