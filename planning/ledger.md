...
| `defthm` and `defthmd` events | 7413 |
| `defun` events | 5674 |
| Functions with verified guards | 1852 |
| Functions declared `:verify-guards nil` and never verified | 307 |
| Functions left at the default with an explicit guard | 2786 |
| Functions left at the default with no guard | 729 |
| `assert-event` checks | 8238 |
