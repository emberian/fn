...
| `defthm` and `defthmd` events | 7584 |
| `defun` events | 5784 |
...
| `books/byte-store-record-provenance.lisp` | root | 26 | 0 | 0/0/0/0 | 0 | 0 | 0 |
...
| `tests/acl2/byte-store-record-provenance-tests.lisp` | root | 0 | 3 | 0/0/0/3 | 4 | 3 | 0 |
