...
| --- | --- |
| Books read | 534 |
| Certification roots in the Makefile | 529 |
| Books inside the root closure | 533 |
| `defthm` and `defthmd` events | 7983 |
| `defun` events | 6030 |
| Functions with verified guards | 1966 |
| Functions declared `:verify-guards nil` and never verified | 322 |
| Functions left at the default with an explicit guard | 2987 |
| Functions left at the default with no guard | 755 |
| `assert-event` checks | 8763 |
...
| `books/bp-fnbs-codec.lisp` | root | 1 | 12 | 0/1/11/0 | 0 | 0 | 0 |
...
| `books/byte-store-record-provenance.lisp` | root | 71 | 0 | 0/0/0/0 | 0 | 0 | 0 |
...
| `books/consumer-store-invariants.lisp` | root | 77 | 5 | 0/5/0/0 | 0 | 0 | 0 |
...
| `books/nntp-invariants.lisp` | root | 98 | 4 | 0/0/0/4 | 0 | 0 | 0 |
...
| `books/nntp-pinned-effects.lisp` | root | 6 | 0 | 0/0/0/0 | 0 | 0 | 0 |
...
| `books/owner.lisp` | root | 62 | 134 | 0/3/131/0 | 0 | 0 | 0 |
...
| `books/peer-inbound.lisp` | root | 71 | 61 | 9/4/48/0 | 0 | 0 | 0 |
...
| `books/store-node-traces.lisp` | root | 75 | 8 | 5/0/1/2 | 0 | 0 | 1 |
...
| `books/topic-history-store-events.lisp` | root | 3 | 8 | 0/0/8/0 | 0 | 0 | 1 |
...
| `tests/acl2/bp-node-receive-boundary-tests.lisp` | root | 0 | 0 | 0/0/0/0 | 19 | 1 | 0 |
...
| `tests/acl2/byte-store-record-provenance-tests.lisp` | root | 1 | 16 | 0/1/0/15 | 14 | 12 | 0 |
...
| `tests/acl2/consumer-store-invariants-tests.lisp` | root | 0 | 0 | 0/0/0/0 | 27 | 3 | 0 |
...
| `tests/acl2/native-admin-tests.lisp` | root | 0 | 1 | 0/0/0/1 | 106 | 2 | 0 |
...
| `tests/acl2/owner-tests.lisp` | root | 0 | 15 | 0/0/1/14 | 302 | 2 | 0 |
...
| `tests/acl2/topic-history-store-events-tests.lisp` | root | 0 | 0 | 0/0/0/0 | 12 | 1 | 0 |
| `tests/acl2/topic-history-store-union-tests.lisp` | root | 0 | 0 | 0/0/0/0 | 13 | 0 | 0 |
...
| `fn-th-topic-decode-refuses-oversize` | `books/topic-history-store-events.lisp` | 153 | branch-of-definition: the hypothesis is a branch test of fn-th-topic-event-decode-exact and the conclusion is that branch's value |
