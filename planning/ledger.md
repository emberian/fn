...
| `defthm` and `defthmd` events | 6595 |
| `defun` events | 5183 |
...
| `books/store-node-invariants.lisp` | root | 75 | 2 | 0/1/0/1 | 0 | 0 | 1 |
...
| `fn-sn-finish-disabled-is-no-op` | `books/store-node-invariants.lisp` | 230 | branch-of-definition: the hypothesis negates a branch test of fn-sn-finish and the conclusion is that branch's value |
