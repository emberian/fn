...
| Functions left at the default with an explicit guard | 626 |
| Functions left at the default with no guard | 432 |
| `assert-event` checks | 3120 |
...
| `books/container.lisp` | root | 1 | 43 | 0/1/42/0 | 0 | 0 | 0 |
