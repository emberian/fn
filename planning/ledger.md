...
| `defthm` and `defthmd` events | 12474 |
| `defun` events | 8710 |
| Functions with verified guards | 2181 |
| Functions declared `:verify-guards nil` and never verified | 664 |
| Functions left at the default with an explicit guard | 4590 |
| Functions left at the default with no guard | 1275 |
| `assert-event` checks | 12960 |
| `must-fail` checks | 1421 |
| `encapsulate` events | 61 |
| Theorems flagged SUSPECT by shape | 109 |
| Export-hygiene warnings | 149 |
| Enabled-projection warnings | 43 |
| Teeth-form warnings | 104 |
| Include-hygiene warnings | 897 |
...
| `books/store-reclaim-pack.lisp` | root | 25 | 10 | 0/9/1/0 | 0 | 0 | 2 |
...
| `tests/acl2/native-operator-tests.lisp` | root | 0 | 2 | 0/0/0/2 | 178 | 16 | 0 |
...
| `tests/acl2/store-reclaim-pack-tests.lisp` | root | 0 | 3 | 0/0/0/3 | 19 | 4 | 0 |
...
| `fn-nop-native-action-of-unaccepted` | `books/native-operator.lisp` | 1232 | branch-of-definition: the hypothesis is a branch test of fn-native-operator-result-native-action and the conclusion is that branch's value |
...
| `fn-rclp-event-of-an-unrewritten-event-by-definition` | `books/store-reclaim-pack.lisp` | 116 | branch-of-definition: the hypothesis negates a branch test of fn-rclp-event and the conclusion is that branch's value |
...
| `store-event-decode-of-a-record-octets` | `books/store-reclaim-pack.lisp` | 163 | branch-of-definition: the hypothesis is a branch test of fn-store-event-decode-exact and the conclusion is that branch's value |
