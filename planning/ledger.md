...
| `fn-bs-names-outcomes-of-no-ops` | `books/byte-store-scan.lisp` | 298 | branch-of-definition: the hypothesis negates a branch test of fn-bs-names-outcomes and the conclusion is that branch's value |
