...
| `defthm` and `defthmd` events | 9637 |
| `defun` events | 6845 |
...
| `assert-event` checks | 10567 |
| `must-fail` checks | 813 |
...
| `books/owner-offer-indexed.lisp` | root | 40 | 0 | 0/0/0/0 | 0 | 0 | 0 |
