...
| `defthm` and `defthmd` events | 5580 |
| `defun` events | 3932 |
| Functions with verified guards | 1463 |
...
| `books/store-node-invariants.lisp` | root | 59 | 2 | 0/1/0/1 | 0 | 0 | 1 |
...
| `books/store-observed.lisp` | root | 37 | 13 | 12/0/1/0 | 0 | 0 | 1 |
