...
| --- | --- |
| Books read | 732 |
| Certification roots in the Makefile | 721 |
| Books inside the root closure | 730 |
| `defthm` and `defthmd` events | 9749 |
| `defun` events | 6879 |
...
| `assert-event` checks | 10657 |
| `must-fail` checks | 843 |
