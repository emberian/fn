...
| `defthm` and `defthmd` events | 8040 |
| `defun` events | 6042 |
...
| Functions left at the default with no guard | 774 |
| `assert-event` checks | 8798 |
| `must-fail` checks | 413 |
...
| `books/byte-store-record-provenance.lisp` | root | 76 | 0 | 0/0/0/0 | 0 | 0 | 0 |
...
| `tests/acl2/byte-store-record-provenance-tests.lisp` | root | 1 | 19 | 0/1/0/18 | 19 | 18 | 0 |
