...
| `defthm` and `defthmd` events | 8377 |
| `defun` events | 6249 |
...
| Functions left at the default with no guard | 798 |
| `assert-event` checks | 9122 |
| `must-fail` checks | 476 |
...
| `books/byte-store-record-provenance.lisp` | root | 141 | 0 | 0/0/0/0 | 0 | 0 | 0 |
...
| `tests/acl2/byte-store-record-provenance-tests.lisp` | root | 1 | 31 | 0/1/0/30 | 33 | 39 | 0 |
