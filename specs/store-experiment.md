...
is staged. A format-5 JSON metadata store is retained in place and refused for
normal open pending an explicit offline migration; the adapter never rewrites
it while opening. The
